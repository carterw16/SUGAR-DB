...
class Writer(AbstractWriter):
    ...
    def smallest_perimeter(
            self,
            n):  # Used for calculating panel dimensions with smallest perimiter
        n_orig = n
        factors = []
        i = 2
        while i * i <= n:
    ...
    def transformer_connection_configuration_mapping(
        ...
        **Mapping:**
        ...
        if value1 == "Y" and value2 == "Y":
            ...
            raise ValueError(
                "Unknown connection configuration for {v1} (wdg1) and {v2} (wdg2)"
    ...
    def merge(self, string1, string2):
        ...
        s2 = string2.split(",")
        if len(s1) != len(s2):
            raise ValueError("Unable to merge {s1} and {s2}".format(s1=s1,
                                                                    s2=s2))
        new_string = ""
    ...
    def write_network_file(self, model, **kwargs):
        ...
        with open(output_file, "w") as f:
            ...
            for i in model.models:
                if (hasattr(i, "from_element") and
                        i.from_element is not None and
                        hasattr(i, "from_element_connection_index") and
                        i.from_element_connection_index is not None):
                    self.node_connector_string_mapping[(
                        i.from_element,
                        i.from_element_connection_index)] = "{f}_{t}".format(
                            f=i.from_element, t=i.to_element)
                    if (len(self.node_connector_string_mapping[(
                            i.from_element, i.from_element_connection_index)]) >
                            64):
                        hasher = hashlib.sha1()
                        hasher.update(self.node_connector_string_mapping[(
                            i.from_element,
                            i.from_element_connection_index)].encode("utf-8"))
                        self.node_connector_string_mapping[(
                            i.from_element, i.from_element_connection_index
                        )] = hasher.hexdigest()

                if (hasattr(i, "to_element") and i.to_element is not None and
                        hasattr(i, "to_element_connection_index") and
                        i.to_element_connection_index is not None):
                    self.node_connector_string_mapping[(
                        i.to_element,
                        i.to_element_connection_index)] = "{f}_{t}".format(
                            f=i.from_element, t=i.to_element)
                    if (len(self.node_connector_string_mapping[
                        (i.to_element, i.to_element_connection_index)]) > 64):
                        hasher = hashlib.sha1()
                        hasher.update(self.node_connector_string_mapping[(
                            i.to_element,
                            i.to_element_connection_index)].encode("utf-8"))
                        self.node_connector_string_mapping[(
            ...
            for i in model.models:
                ...
                if isinstance(i, PowerSource):
                    ...
                    if hasattr(i, "is_sourcebus") and i.is_sourcebus == 1:
                        ...
                        if (hasattr(i, "connecting_element") and
                                i.connecting_element is not None):
                        ...
                        if (hasattr(i, "nominal_voltage") and
                                i.nominal_voltage is not None):
                            new_source_string += "," + str(
                                i.nominal_voltage * 10**-3)
                            self.sources[i.connecting_element] = str(
                                i.nominal_voltage * 10**-3)
                            self.substations[-1]["KVLL"] = str(
                                i.nominal_voltage * 10**-3)
                        elif (hasattr(i, "connecting_element") and
                              i.connecting_element is not None and
                              i.connecting_element in model.model_names and
                              hasattr(model[i.connecting_element],
                                      "nominal_voltage") and
                              model[i.connecting_element].nominal_voltage
                              is not None):
                            voltage = model[
                                i.connecting_element].nominal_voltage
                            new_source_string += "," + str(voltage * 10**-3)
                            self.sources[i.connecting_element] = str(voltage *
                                                                     10**-3)
                        ...
                        if hasattr(i,
                                   "phase_angle") and i.phase_angle is not None:
                            new_source_string += "," + str(i.phase_angle)
                            new_source_string += "," + str(i.phase_angle - 120)
                            new_source_string += "," + str(i.phase_angle + 120)
                            self.substations[-1]["phase_angle"] = str(
                                i.phase_angle)
                        else:
                            new_source_string += ",,,"

                        if (hasattr(i, "positive_sequence_impedance") and
                                i.positive_sequence_impedance is not None):
                            new_source_string += (
                        ...
                        if (hasattr(i, "zero_sequence_impedance") and
                                i.zero_sequence_impedance is not None):
                            new_source_string += (
                        ...
                        if (hasattr(i, "negative_sequence_impedance") and
                                i.negative_sequence_impedance is not None):
                            new_source_string += (
                                "," + str(i.negative_sequence_impedance.real) +
                                "," + str(i.negative_sequence_impedance.imag))
                        elif (hasattr(i, "zero_sequence_impedance") and
                              i.zero_sequence_impedance is not None):
                            new_source_string += (
                                "," + str(i.zero_sequence_impedance.real) +
                                "," + str(i.zero_sequence_impedance.imag))
                        ...
                        if hasattr(i,
                                   "rated_power") and i.rated_power is not None:
                            self.substations[-1]["MVA"] = str(i.rated_power *
                                                              10**-6)
                ...
                if isinstance(i, Node):
                    ...
                    # CoordX and CoordY
                    if (hasattr(i, "positions") and i.positions is not None and
                            len(i.positions) == 1):
                        ...
                        try:
                            ...
                            new_node_string += ",0"
                    elif (hasattr(i, "positions") and
                          i.positions is not None and len(i.positions) >= 2):
                        ...
                        for j in range(1, len(i.positions) - 1):
                            sectionid = ""
                            if (i.name, j -
                                    1) in self.node_connector_string_mapping:
                ...
                if isinstance(i, Line):
                    ...
                    if hasattr(i, "name") and i.name is not None:
                        ...
                        if hasattr(i, "line_type"):
                            ...
                            if (hasattr(i, "nominal_voltage") and
                                    i.nominal_voltage is not None and
                                    i.nominal_voltage < 600):
                        ...
                        if (hasattr(i, "from_element") and
                                i.from_element is not None and
                                hasattr(i, "to_element") and
                                i.to_element is not None):
                            new_section_ID = "{f}_{t}".format(f=i.from_element,
                                                              t=i.to_element)
                            if hasattr(i, "feeder_name"
                                      ) and i.feeder_name is not None:
                                if i.feeder_name in self.section_feeder_mapping:
                                    while (new_section_ID
                                           in self.section_feeder_mapping[
                                               i.feeder_name]):
                                        new_section_ID = (
                                            new_section_ID + "*"
                            ...
                            from_index = 0
                            to_index = 0
                            if (hasattr(i, "from_element_connection_index") and
                                    i.from_element_connection_index
                                    is not None):
                                from_index = i.from_element_connection_index
                            if (hasattr(i, "to_element_connection_index") and
                                    i.to_element_connection_index is not None):
                            ...
                            if hasattr(i, "feeder_name"
                                ...
                                if i.feeder_name in self.section_feeder_mapping:
                                    self.section_feeder_mapping[
                                        i.feeder_name].append(new_section_ID)
                                else:
                                    self.section_feeder_mapping[
                                        i.feeder_name] = [new_section_ID]
                                if (hasattr(i, "substation_name") and
                                        i.substation_name is not None):
                                    self.section_headnode_mapping[
                                        i.feeder_name] = i.substation_name
                        else:
                            raise ValueError(
                                "Line {name} does not have from and to.".format(
                                    name=i.name))

                        if (hasattr(i, "positions") and
                                i.positions is not None and
                                len(i.positions) > 0):
                        ...
                        if hasattr(i, "wires") and i.wires is not None:
                            ...
                            for wire in i.wires:
                                ...
                                if hasattr(wire,
                                           "phase") and wire.phase is not None:
                                ...
                                new_code = ""
                                if (hasattr(wire, "diameter") and
                                        wire.diameter is not None):
                                    new_code += ",{}".format(wire.diameter)
                                else:
                                    new_code += ","

                                if hasattr(wire,
                                           "gmr") and wire.gmr is not None:
                                ...
                                # i.e. WARNING - 2x2 matrix cross terms won't match
                                        ...
                                        len(i.impedance_matrix) == 1 or
                                        len(i.impedance_matrix) == 2):

                                    if isinstance(i.impedance_matrix, list):
                                        x_in_miles = i.impedance_matrix[0][
                                            0].imag
                                    else:
                                    ...
                                    try:
                                        gmr_in_feet = 1 / (
                                            np.exp((x_in_miles / coeff1) -
                                                   coeff2)
                                        )  # Solving Kerstin 4.41 for GMR
                                    except OverflowError:
                                        gmr_in_feet = float('inf')
                                ...
                                if (hasattr(wire, "resistance") and
                                        wire.resistance is not None):
                                    ...
                                    if isinstance(i.impedance_matrix, list):
                                        r_in_miles = i.impedance_matrix[0][
                                            0].real
                                    else:
                                ...
                                if (hasattr(wire, "ampacity") and
                                        wire.ampacity is not None):
                                    new_code += ",{}".format(wire.ampacity)
                                else:
                                    new_code += ","

                                if (hasattr(wire, "emergency_ampacity") and
                                        wire.emergency_ampacity is not None):
                                    new_code += ",{}".format(
                                        wire.emergency_ampacity)
                                else:
                                    new_code += ",".format(
                                        wire.emergency_ampacity)
                                ...
                                if (hasattr(wire, "nameclass") and
                                        wire.nameclass is not None and
                                        wire.nameclass != ""):
                                ...
                                # The IDs will be wire_1, wire_2,...
                                    ...
                                    if not found:
                                        ID_cond += 1
                                        self.conductors["conductor_{}".format(
                                            ID_cond)] = new_code
                        ...
                        if line_type == "switch":
                            if (i.nameclass is not None and
                                    i.nameclass != "" and
                                    i.wires[0].ampacity is not None and
                                    i.nominal_voltage is not None):
                                ...
                                if (i.nameclass + "_" +
                                    ...
                                    self.switchcodes[
                                        ...
                                        str(int(i.nominal_voltage)) + "_" +
                                        str(int(
                                            i.wires[0].ampacity))] = new_code2
                                    new_line_string += (
                                        "," + i.nameclass + "_" +
                                        str(int(i.nominal_voltage)) + "_" +
                                        str(int(i.wires[0].ampacity)))

                                elif (self.switchcodes[i.nameclass + "_" + str(
                                        int(i.nominal_voltage)) + "_" + str(
                                            int(i.wires[0].ampacity))] !=
                                      new_code2):
                                    found = False
                            ...
                            if (i.nameclass is not None and
                                ...
                                if (i.nameclass + "_" +
                                ...
                                elif (self.fusecodes[i.nameclass + "_" + str(
                                        int(i.nominal_voltage)) + "_" + str(
                                            int(i.wires[0].ampacity))] !=
                                      new_code2):
                                    found = False
                                    for k, v in self.fusecodes.items():
                                        if new_code2 == v:
                                            ...
                                            found = True
                                    if not found:
                                        self.fusecodes[i.nameclass + "_" + str(
                                            int(i.nominal_voltage)) + "_" + str(
                                                int(i.wires[0].ampacity)
                                            )] = new_code2
                                        new_line_string += (
                            ...
                            if (i.nameclass is not None and
                                ...
                                elif (self.breakercodes[i.nameclass + "_" + str(
                                        int(i.nominal_voltage)) + "_" + str(
                                            int(i.wires[0].ampacity))] !=
                                      new_code2):
                                    found = False
                            ...
                            if (hasattr(i, "impedance_matrix") and
                                    i.impedance_matrix is not None):
                                z_diag = 0
                                z_offdiag = 0
                                try:
                                    for kk in range(len(i.impedance_matrix)):
                                        if i.impedance_matrix[kk][kk] != 0:
                                            ...
                                            for jj in range(
                                                ...
                                                if jj == kk:
                                                    continue
                                                if i.impedance_matrix[kk][
                                                        jj] != 0:
                                                    z_offdiag = i.impedance_matrix[
                                                        kk][jj]
                                    ...
                                    try:
                                        ...
                                        raise ValueError(
                                            "Cannot get a value from impedance matrix for line {}"
                                            .format(i.name))
                                coeff = 10**3
                                ...
                                if (hasattr(i, "capacitance_matrix") and
                                        i.capacitance_matrix is not None):
                                    c_diag = 0
                                    c_offdiag = 0
                                    try:
                                        for kk in range(len(
                                ...
                                if (hasattr(i.wires[0], "nameclass") and
                                        i.wires[0].nameclass is not None and
                                        i.wires[0].nameclass != ""):
                                    ...
                                    if len(self.cablecodes) == 0:
                                        ID_cable += 1
                                        self.cablecodes["cable" +
                                                        str(ID_cable)] = tt
                                        new_line_string += ",cable_" + str(
                                            ID_cable)
                                    else:
                                        found = False
                            ...
                            if len(phases
                                  ) == 3 and i.impedance_matrix is not None:
                                    ...
                                    for j, p2 in enumerate(phases):
                                        if j == k:
                                            ...
                                            if p1 == "A" and p2 == "C":
                                                ...
                                                tt["MutualResistance{p1}{p2}".
                                                   format(p1=p1, p2=p2)] = (
                                                       i.impedance_matrix[k]
                                                       [j].real * 10**3)
                                                tt["MutualReactance{p1}{p2}".
                                                   format(p1=p1, p2=p2)] = (
                                                       i.impedance_matrix[k]
                                                       [j].imag * 10**3)
                                                if i.capacitance_matrix is not None and len(
                                                    ...
                                                    tt["MutualShuntSusceptance{p1}{p2}"
                                                       .
                                                       format(p1=p1, p2=p2)] = (
                                                           i.capacitance_matrix[
                                                               k][j].real * 2 *
                                ...
                                if (hasattr(i, "nameclass") and
                                        i.nameclass is not None and
                                        i.nameclass != ""):
                        ...
                        if hasattr(i, "length") and i.length is not None:
                            if (line_type != "switch" and
                                    line_type != "fuse" and
                                    line_type != "recloser" and
                                    line_type != "breaker"):
                                try:
                        ...
                        if line_type == "switch" or line_type == "breaker":
                            closed_phase = np.sort([
                                wire.phase
                                for wire in i.wires
                                if wire.is_open == 0 and
                                wire.phase not in ["N", "N1", "N2"]
                            ])
                        ...
                        # DeviceNumber
                        if (line_type == "switch" or line_type == "fuse" or
                                line_type == "recloser" or
                                line_type == "breaker"):
                            new_line_string += "," + new_section_ID
                        ...
                        if new_section_line != "":
                            ...
                            elif (hasattr(i, "feeder_name") and
                                  i.feeder_name is not None and
                                  i.feeder_name != ""):
                                ff_name = i.feeder_name

                            if ff_name in self.section_line_feeder_mapping:
                                self.section_line_feeder_mapping[
                                    ff_name].append(new_section_line)
                            else:
                ...
                if isinstance(i, Storage):
                    ...
                    if (hasattr(i, "name") and i.name is not None and
                            hasattr(i, "connecting_element") and
                            i.connecting_element is not None and
                        (i.connecting_element in model.model_names or
                         "load_" + i.connecting_element in model.model_names)):
                        ...
                        new_section = (
                            new_section_ID + ",{f},0,{t},0,".
                            format(  # Assume only one index for the load connection point
                                f=i.connecting_element,
                                t=i.name))
                        ...
                        if (hasattr(i, "charging_efficiency") and
                                i.charging_efficiency is not None):
                            bess_string += str(i.charging_efficiency)
                        bess_string += ","

                        if (hasattr(i, "discharging_efficiency") and
                                i.discharging_efficiency is not None):
                        ...
                        new_bess_setting_string += (new_section_ID + ",M," +
                                                    new_section_ID + "," +
                                                    bess_type + "," + phases +
                                                    ",")

                        if (hasattr(i, "stored_kWh") and
                                i.stored_kWh is not None and
                                hasattr(i, "rated_kWh") and
                                i.rated_kWh is not None and i.rated_kWh != 0):
                            new_bess_setting_string += str(
                                int(i.stored_kWh / i.rated_kWh * 100))

                        if hasattr(i, "active_rating"
                                  ) and i.active_rating is not None:
                            if (hasattr(i, "reactive_rating") and
                                    i.reactive_rating is not None):
                                new_converter_string += (str(
                                    math.sqrt(i.reactive_rating**2 +
                                              i.active_rating**2) / 1000.0) +
                                                         ",")
                            else:
                                new_converter_string += (
                                    str(i.active_rating / 1000.0) + ",")
                            new_converter_string += str(
                                i.active_rating / 1000.0) + ","
                        elif hasattr(
                                i, "rated_power") and i.rated_power is not None:
                            if (hasattr(i, "reactive_rating") and
                                    i.reactive_rating is not None):
                                new_converter_string += (str(
                                    math.sqrt(i.reactive_rating**2 +
                        ...
                        if hasattr(i,
                                   "rated_power") and i.rated_power is not None:
                            new_dg_generation_string += str(i.rated_power /
                                                            1000.0)
                        elif hasattr(
                                i, "rated_power") and i.rated_power is not None:
                            new_dg_generation_string += str(i.rated_power /
                        ...
                        if (hasattr(i, "min_powerfactor") and
                                i.min_powerfactor is not None):
                            new_converter_string += str(i.powerfactor * 100)
                            new_dg_generation_string += str(i.powerfactor * 100)
                        new_dg_generation_string += ","
                        new_converter_string += ","
                        if hasattr(i,
                                   "fall_limit") and i.fall_limit is not None:
                            new_converter_string += str(i.fall_limit)
                        new_converter_string += ","
                        if hasattr(i,
                                   "rise_limit") and i.rise_limit is not None:
                            new_converter_string += str(i.rise_limit)
                        new_converter_string += ","
                        if (hasattr(i, "fall_limit") and i.fall_limit
                                is not None) or (hasattr(i, "rise_limit") and
                                                 i.rise_limit is not None):
                            new_converter_string += "0"  # Using units of % per minute

                        if hasattr(
                                i,
                                "control_type") and i.control_type is not None:
                            if (i.control_type.lower()
                                    == "voltvar_vars_over_watts" or
                                    i.control_type.lower() == "voltvar"
                               ):  # use default voltvar curve in cyme
                                new_converter_control_setting_string += "1"
                            if i.control_type.lower(
                            ) == "voltvar_watts_over_vars":
                            ...
                            if (i.control_type.lower() == "voltvar_fixed_vars"
                                ...
                                new_converter_control_setting_string += ",,"
                            if (i.control_type.lower()
                                    == "voltvar_watts_over_vars" or
                                    i.control_type.lower()
                                    == "voltvar_vars_over_watts"
                               ) and i.voltvar_curve is not None:
                                new_converter_control_setting_string += (
                                    i.voltvar_curve + ",,")
                            elif (i.control_type.lower() == "voltwatt" and
                                  i.voltwatt_curve is not None):
                                new_converter_control_setting_string += (
                                    i.voltwatt_curve + ",0,"
                                )  # 0 is the code for using the active power rating
                            elif (i.control_type.lower() == "watt_powerfactor"
                    ...
                    if new_bess_setting_string != "":
                        bess_settings_string_list.append(
                            new_bess_setting_string)
                ...
                if isinstance(i, Photovoltaic):
                    ...
                    if (hasattr(i, "name") and i.name is not None and
                        ...
                        self.section_line_list.append(new_section)
                        if hasattr(i,
                                   "feeder_name") and i.feeder_name is not None:
                            if i.feeder_name in self.section_line_feeder_mapping:
                                self.section_line_feeder_mapping[
                                    i.feeder_name].append(new_section)
                            else:
                                self.section_line_feeder_mapping[
                                    i.feeder_name] = [new_section]
                        ...
                        if hasattr(i,
                            ...
                            panel_area = math.ceil(
                                i.rated_power / 1000 /
                                0.08)  # Each panel produces 0.08 kw
                            num_x, num_y = self.smallest_perimeter(panel_area)
                            if min(num_x, num_y) == 1:
                                num_x, num_y = self.smallest_perimeter(
                                    panel_area + 1)  # if area is prime
                            new_pv_setting_string += str(num_x) + "," + str(
                                num_y) + ","
                        elif (hasattr(i, "active_rating") and
                              i.active_rating is not None):
                            panel_area = math.ceil(
                        ...
                        if hasattr(i,
                                   "temperature") and i.temperature is not None:
                        ...
                        if hasattr(
                            ...
                            if (i.control_type.lower() == "powerfactor" and
                                    i.powerfactor is not None):
                        ...
                        if (hasattr(i, "timeseries") and
                                i.timeseries is not None and
                                len(i.timeseries) > 0 and
                                i.timeseries[0].data_label is not None and
                                i.timeseries[0].data_location is not None):
                            new_pv_setting_string += ",0,{loc}".format(
                                loc=i.timeseries[0].data_label)
                            self.irradiance_profiles[i.timeseries[
                                0].data_label] = i.timeseries[0].data_location
                        else:
                    ...
                    if new_dg_generation_string != "":
                        dg_generation_string_list.append(
                            new_dg_generation_string)
                ...
                if isinstance(i, Capacitor):
                    ...
                    if (hasattr(i, "name") and i.name is not None and
                        ...
                        try:
                            ...
                            new_section = (
                                new_section_ID + ",{f},0,{t},0,".
                                format(  # assume only one connection point for capacitors
                                    f=i.connecting_element,
                                    t=i.name))
                            ...
                            if i.connecting_element not in self.nodeID_list:
                                ...
                                self.node_string_list.append("{},0,0".format(
                                    i.connecting_element))
                            if i.name not in self.nodeID_list:
                                if hasattr(i, "positions"
                    ...
                    # Connection type
                    if hasattr(i, "connection_type"
                              ) and i.connection_type is not None:
                        try:
                    ...
                    # KVAR and Phase
                    phases = []
                    if (hasattr(i, "phase_capacitors") and
                            i.phase_capacitors is not None):
                        total_var = 0
                        one_var = 0
                        switched_vars = {}
                        # new_capacitor_line+=','
                        for phase_capacitor in i.phase_capacitors:
                            if (hasattr(phase_capacitor, "phase") and
                                    phase_capacitor.phase is not None):
                                phases.append(phase_capacitor.phase)
                                if new_section is not None:
                                    new_section += str(phase_capacitor.phase)

                            if (hasattr(phase_capacitor, "var") and
                                    phase_capacitor.var is not None):
                                total_var += phase_capacitor.var
                            if (phase_capacitor.var is not None and
                                    phase_capacitor.phase is not None):
                                switched_vars[phase_capacitor.phase.upper(
                                )] = phase_capacitor.var
                        ...
                        if "C" in switched_vars:
                            ...
                            new_capacitor_line += ","
                        if total_var > 0:
                            new_capacitor_object_line += str(
                                one_var * 10**-3) + ","
                        else:
                            new_capacitor_object_line += ","

                    # KV
                    if hasattr(i, "nominal_voltage"
                    ...
                    if hasattr(i, "low") and i.low is not None:
                        new_capacitor_line += ("," + str(i.low) + "," +
                                               str(i.low) + "," + str(i.low))
                    else:
                        new_capacitor_line += ",,,"

                    if hasattr(i, "high") and i.high is not None:
                        new_capacitor_line += ("," + str(i.high) + "," +
                                               str(i.high) + "," + str(i.high))
                    else:
                        new_capacitor_line += ",,,"
                ...
                #
                if isinstance(i, Regulator) and not (hasattr(i, "ltc") and i.ltc
                                                     is not None and i.ltc):
                    ...
                    if hasattr(i, "windings") and i.windings is not None:
                        if (len(i.windings) >= 2 and
                            ...
                            if (hasattr(i, "from_element") and
                                ...
                                if (hasattr(i, "from_element_connection_index")
                                        and i.from_element_connection_index
                                        is not None):
                                    from_index = i.from_element_connection_index
                                if (hasattr(i, "to_element_connection_index")
                                        and i.to_element_connection_index
                                        is not None):
                                    to_index = i.to_element_connection_index
                    if winding1 is not None and winding2 is not None:
                        ...
                        if winding1.nominal_voltage != winding2.nominal_voltage:
                            ...
                            if len(new_trans_sectionID) > 64:
                                hasher = hashlib.sha1()
                                hasher.update(
                                    new_trans_sectionID.encode("utf-8"))
                                new_trans_sectionID = hasher.hexdigest()
                            new_trans_section = (new_trans_sectionID +
                                                 ",{f},{fi},{t},{ti},".format(
                                                     f=from_element,
                                                     fi=from_index,
                                                     t=to_element + "_reg",
                            ...
                            new_section_ID = "{f}_{t}".format(f=to_element +
                                                              "_reg",
                                                              t=to_element)
                            if len(new_section_ID) > 64:
                                hasher = hashlib.sha1()
                            ...
                            phase_on = ""
                            if (hasattr(winding1, "phase_windings") and
                                    winding1.phase_windings is not None):
                                for phase_winding in winding1.phase_windings:
                                    if new_trans_section is not None:
                                        if (hasattr(phase_winding, "phase") and
                                                phase_winding.phase
                                                is not None):
                            ...
                            if (new_trans_section is not None and
                                    new_trans_section
                                    not in self.section_line_list):
                                self.section_line_list.append(new_trans_section)
                                # If the object is inside of a substation...
                                if hasattr(i, "is_substation"
                                          ) and i.is_substation == 1:
                                    # ...it should have the name of the substation specified in the 'substation_name' attribute
                                    if (hasattr(i, "substation_name") and
                                            i.substation_name is not None and
                                            i.substation_name != ""):
                            ...
                            # CoordX and CoordY
                            if hasattr(i,
                                       "positions") and i.positions is not None:
                                try:
                            ...
                            try:
                                new_transformer_line += (
                                    "," + self.
                                    transformer_connection_configuration_mapping(
                            ...
                            if (hasattr(winding1, "resistance") and
                                ...
                                try:
                                    RH = (winding1.resistance * 10**-2 *
                                          winding1.rated_power * 10**-3)
                                    RL = (winding2.resistance * 10**-2 *
                                          winding2.rated_power * 10**-3)
                                except:
                                    RH = 0
                                    RL = 0
                            ...
                            try:
                                Z1 = _ZHL_ * 100.0 / (winding1.rated_power *
                                                      10**-3)
                            except:
                                Z1 = 0
                            Z0 = Z1
                            ...
                            for w, winding in enumerate(windings_local):
                                ...
                                if hasattr(winding, "nominal_voltage"):
                                    try:
                                        ...
                                        pass
                                # NoLoadLosses
                                if (hasattr(i, "noload_loss") and
                                        i.noload_loss is not None):
                            ...
                            for k, d in self.two_windings_trans_codes.items():
                                if d == new_transformer_object_line:
                                    new_transformer_line += (",transformer_" +
                                                             str(k) +
                                                             ",transformer_" +
                                                             str(k))
                                    found = True
                            if not found:
                                ID_trans += 1
                                self.two_windings_trans_codes[
                                    ID_trans] = new_transformer_object_line
                                new_transformer_line += (",transformer_" +
                                                         str(ID_trans) +
                                                         ",transformer_" +
                                                         str(ID_trans))
                    ...
                    if (new_section is not None and
                            new_section not in self.section_line_list):
                        self.section_line_list.append(new_section)
                        # If the object is inside of a substation...
                        if hasattr(i, "is_substation") and i.is_substation == 1:
                            # ...it should have the name of the substation specified in the 'substation_name' attribute
                    ...
                    if len(windings_local) >= 2:
                        try:
                            ...
                            pass
                        _KVLN = (windings_local[-1].nominal_voltage /
                                 math.sqrt(3) * 10**-3)
                        ...
                        if (hasattr(winding1, "phase_windings") and
                            ...
                            for phase_winding in winding1.phase_windings:
                                try:
                                    ...
                                    _Rset[phase_winding.
                                          phase] = phase_winding.compensator_r
                                    _Xset[phase_winding.
                                          phase] = phase_winding.compensator_x
                                except:
                                    pass
                ...
                #
                if (isinstance(i, PowerTransformer) and
                    (i.name not in self.transformers_to_ignore)) or (isinstance(
                        i, Regulator) and (hasattr(i, "ltc") and
                                           i.ltc is not None and i.ltc == 1)):
                    ...
                    new_section = None
                    new_section_ID = None
                    if (hasattr(transformer_object, "from_element") and
                            transformer_object.from_element is not None and
                            hasattr(transformer_object, "to_element") and
                            transformer_object.to_element is not None):
                        from_index = 0
                        to_index = 0
                        if (hasattr(transformer_object,
                                    "from_element_connection_index") and
                                transformer_object.from_element_connection_index
                                is not None):
                            from_index = (transformer_object.
                                          from_element_connection_index)
                        if (hasattr(transformer_object,
                                    "to_element_connection_index") and
                                transformer_object.to_element_connection_index
                                is not None):
                    ...
                    if hasattr(i, "bandwidth") and i.bandwidth is not None:
                        bandcenter = 0
                        if hasattr(i,
                                   "bandcenter") and i.bandcenter is not None:
                    ...
                    if (hasattr(transformer_object, "windings") and
                            transformer_object.windings is not None):

                        phase_on = ""
                        if (hasattr(transformer_object.windings[0],
                                    "phase_windings") and
                            ...
                            for phase_winding in transformer_object.windings[
                                ...
                                if new_section is not None:
                                    if (hasattr(phase_winding, "phase") and
                                            phase_winding.phase is not None):
                                        new_section += str(phase_winding.phase)
                                        phase_on += str(phase_winding.phase)
                        ...
                        if (new_section is not None and
                            ...
                            self.section_line_list.append(new_section)
                            # If the object is inside of a substation...
                            if (hasattr(transformer_object, "is_substation") and
                                    transformer_object.is_substation == 1):
                                # ...it should have the name of the substation specified in the 'substation_name' attribute
                                if (hasattr(transformer_object,
                                            "substation_name") and
                                    ...
                                    self.network_have_substations = True
                            # If the object is not inside of a substation, then use the feeder_name attribute if it exists
                            elif (hasattr(transformer_object, "feeder_name") and
                                  transformer_object.feeder_name is not None and
                                  transformer_object.feeder_name != ""):
                        ...
                        # Case 1: Two Windings
                        #
                        if (len(transformer_object.windings) == 2 or
                            ...
                            if (hasattr(transformer_object.windings[0],
                                        "phase_windings") and
                                    transformer_object.windings[0].
                                    phase_windings is not None):
                                try:
                                    if (transformer_object.is_center_tap == True
                                            and
                                            len(transformer_object.windings[0].
                                                phase_windings) == 1):
                                        TYPE = 4
                                    elif (len(transformer_object.windings[0].
                                              phase_windings) == 1):
                                        TYPE = 1
                                    elif (len(transformer_object.windings[0].
                                              phase_windings) == 3):
                            ...
                            # CoordX and CoordY
                            if (hasattr(transformer_object, "positions") and
                                    transformer_object.positions is not None):
                                try:
                                    new_transformer_line += "," + str(
                            ...
                            if TYPE == 4:
                                if (hasattr(transformer_object, "reactances")
                                        and transformer_object.reactances
                                        is not None and len(i.reactances) == 3):
                                    ...
                                    if (hasattr(transformer_object.windings[0],
                                        ...
                                        KVA_BASE = (transformer_object.
                                                    windings[0].rated_power *
                                                    10**-3)
                                ...
                                if (hasattr(transformer_object, "reactances")
                                        and transformer_object.reactances
                                        is not None and
                                        len(transformer_object.reactances)
                                        == 1):
                                ...
                                if (hasattr(transformer_object.windings[0],
                                            "resistance") and
                                        hasattr(transformer_object.windings[1],
                                                "resistance") and
                                        transformer_object.windings[0].
                                        resistance is not None and
                                        transformer_object.windings[1].
                                    ...
                                    # Resistance is given as a percentage of the KVA of the corresponding winding
                                    try:
                                        RH = (transformer_object.windings[0].
                                              resistance * 10**-2 *
                                              transformer_object.windings[0].
                                              rated_power * 10**-3)
                                        RL = (transformer_object.windings[1].
                                              resistance * 10**-2 *
                                              transformer_object.windings[1].
                                              rated_power * 10**-3)
                                    except:
                            ...
                            for w, winding in enumerate(
                                ...
                                if hasattr(winding, "nominal_voltage"):
                                    ...
                                    if (len(transformer_object.windings[0].
                                            phase_windings) <= 1 or
                                            len(transformer_object.windings[0].
                                                phase_windings) == 2):
                                        if w == 0:
                                    ...
                                    # Note: If we have three phases, the transformer shouln't be a center tap
                                        ...
                                        if w == 0:
                                            ...
                                            voltageUnit = 0
                                        if w == 1:
                                            KVLLsec = (winding.nominal_voltage *
                                                       10**-3)  # *math.sqrt(3)
                                            voltageUnit = 0

                            # NoLoadLosses
                            if (hasattr(transformer_object, "noload_loss") and
                                    transformer_object.noload_loss is not None):
                                # TODO: Make sure noloadlosses is in % in DiTTo, or change what is next.
                                NOLOADLOSS = (transformer_object.noload_loss /
                                              100.0 * KVA)
                            else:
                                NOLOADLOSS = ""
                        ...
                        #
                            ...
                            # Name
                            if (hasattr(transformer_object, "name") and
                                    transformer_object.name is not None):
                                try:
                                    new_transformer_line += new_section_ID
                                except:
                                    pass
                            ...
                            for w, winding in enumerate(
                                    transformer_object.windings):
                                if (hasattr(winding, "rated_power") and
                                        winding.rated_power is not None):
                                    if w == 0:
                                ...
                                if (hasattr(winding, "connection_type") and
                                        winding.connection_type is not None):
                                    if w == 0:
                                ...
                                if (hasattr(winding, "nominal_voltage") and
                                        winding.nominal_voltage is not None):
                                    try:
                                        new_transformer_line += "," + str(
                                            winding.nominal_voltage * 10**-3)
                                    except:
                                ...
                                if (hasattr(winding, "resistance") and
                                        winding.resistance is not None):
                                    try:
                                        R[w] = (winding.resistance *
                                                winding.rated_power * 10**-3)
                                    except:
                                        R[w] = None

                            if (hasattr(transformer_object, "reactances") and
                                    i.reactances is not None):
                                try:
                            ...
                            if (sum([x is None for x in R]) == 0 and
                                    XHL is not None and XLT is not None and
                                    XHT is not None):
                            ...
                            for k, d in self.three_windings_trans_codes.items():
                                if d == new_transformer_object_line:
                                    new_transformer_line += (
                                        ",3_wdg_transformer_" + str(k) + "," +
                                        new_section_ID)
                                    found = True
                            if not found:
                                ID_trans_3w += 1
                                self.three_windings_trans_codes[
                                    ID_trans_3w] = new_transformer_object_line
                                new_transformer_line += (",3_wdg_transformer_" +
                                                         str(ID_trans_3w) +
                                                         "," + new_section_ID)
            ...
            if len(self.bus_string_list) > 0:
                f.write(
                    "FORMAT_NODE=NodeID,CoordX1,CoordY1,CoordX2,CoordY2,Width\n"
                )
            ...
            for _source, _voltage in self.sources.items():
                ...
                for obj in model.models:
                    if isinstance(obj,
                                  Feeder_metadata) and obj.headnode == _source:
                ...
                f.write("sub_{k},sub_{k},{nodeID},{NetID}\n".format(
            ...
            for f_name, section_l in self.section_feeder_mapping.items():
                ...
                if f_name != "":
                    head = model[
                        f_name].headnode  # self.section_headnode_mapping[f_name]
                    f.write("{nodeID},{NetID}\n".format(nodeID=head,
                                                        NetID=f_name))
            ...
            for f_name, section_l in self.section_line_feeder_mapping.items():
                if f_name != "subtransmission" and "substation" not in f_name:
                    temp = model[f_name]
                    if (hasattr(temp, "nominal_voltage") and
                            temp.nominal_voltage is not None):
            ...
            if "subtransmission" in self.section_line_feeder_mapping:
                f.write(
                    "FORMAT_TRANSMISSIONLINE=NetworkID,HeadNodeID,CoordSet\n")
                ...
                for f_name, section_l in self.section_line_feeder_mapping.items(
                    ...
                    if "substation" in f_name:
                        ...
                        for obj in model.models:
                            ...
                            if (isinstance(obj, Node) and
                                    len(obj.positions) > 0 and
                                    obj.positions[0] is not None and
                                    obj.positions[0].lat is not None and
                                    obj.positions[0].long is not None):
                            ...
                            if (isinstance(obj, Node) and obj.substation_name
                                    == f_name.split("ation_")[1] and
                                    obj.is_substation_connection == 1):
                                if obj.nominal_voltage is not None:
                                    if (len(obj.positions) > 0 and
                                            obj.positions[0] is not None):
                                        if (obj.positions[0].lat is not None and
                                                obj.positions[0].long
                                                is not None):
                                            if (obj.nominal_voltage
                                                    in by_nominal_voltage_X and
                                                    obj.nominal_voltage
                                                    in by_nominal_voltage_Y):
                                                by_nominal_voltage_X[
                                                    obj.nominal_voltage].append(
                                                        obj.positions[0].long)
                                                by_nominal_voltage_Y[
                                                    obj.nominal_voltage].append(
                                                        obj.positions[0].lat)
                        ...
                        # (CASE 4) - Otherwise, set to 0,0 (best effort...)
                            ...
                            logger.warning(
                                "Could not find any coordinate for substation {s}. Setting the subnetwork coordinates to (0,0)..."
                                .format(s=f_name))
                            X = 0
                            Y = 0
                        f.write(
            ...
            if self.network_have_substations:
                ...
                for f_name, section_l in self.section_line_feeder_mapping.items(
                    ...
                    if "substation" in f_name:
                        ...
                        for obj in model.models:
                            if (isinstance(obj, Node) and
                                    obj.is_substation_connection == 1 and
                                    obj.substation_name
                                    == f_name.split("ation_")[1]):
                                # We also need the coordinates of this connection.
                                # Use the coordinates of the Node
                                if obj.positions is not None and len(
                                        obj.positions) > 0:
    ...
    def write_equipment_file(self, model, **kwargs):
        ...
        with open(output_file, "w") as f:
            ...
            for ID, data in self.cablecodes.items():
                f.write(str(ID))
                for key in [
                        "R1", "R0", "X1", "X0", "B1", "B0", "amps", "cabletype"
                ]:
                    if key in data:
            ...
            f.write("\n[CONDUCTOR]\n")
            f.write(
                "FORMAT_CONDUCTOR=ID,Diameter,GMR,R25,Amps,WithstandRating\n")
            ...
            for i in model.models:
                if isinstance(i, Load):
                    ...
                    if (hasattr(i, "name") and i.name is not None and
                        ...
                        new_section = (
                            new_section_ID + ",{f},0,{t},0,".
                            format(  # Assume loads only have one connection point
                                f=i.connecting_element,
                                t=i.name))
                        if hasattr(i,
                                   "feeder_name") and i.feeder_name is not None:
                    ...
                    if hasattr(i, "phase_loads") and i.phase_loads is not None:
                        ...
                        Q = 0
                        i.phase_loads = [
                            p for p in i.phase_loads if p.drop != 1
                        ]
                        # new_customer_load_string+=','
                        for phase_load in i.phase_loads:
                            if (hasattr(phase_load, "phase") and
                                    phase_load.phase is not None):
                                phases += phase_load.phase
                                if new_section is not None:
                                    new_section += str(phase_load.phase)
                                if (hasattr(phase_load, "p") and
                                        phase_load.p is not None):
                                    try:
                                        P += float(phase_load.p) * 10**-3
                                    except:
                                        pass
                                if (hasattr(phase_load, "q") and
                                        phase_load.q is not None):
                                    try:
                        ...
                        if (len(i.phase_loads) == 1 and
                                hasattr(i, "connection_type") and
                                i.connection_type == "D"):
                            mapp = {"A": "B", "B": "C", "C": "A"}
                            try:
                                new_section = new_section[:-1] + "".join(
                                    sorted(new_section[-1] +
                                           mapp[i.phase_loads[0].phase]))
                            except:
                                pass
                    ...
                    if (hasattr(i, "timeseries") and
                            i.timeseries is not None and len(i.timeseries) > 0):
                        ts = i.timeseries[0]
                        if (hasattr(ts, "data_label") and
                                ts.data_label is not None and
                                len(ts.data_label) > 0):
                    ...
                    #
                    if (hasattr(i, "is_center_tap") and
                            i.is_center_tap == True and
                            hasattr(i, "center_tap_perct_1_N") and
                            i.center_tap_perct_1_N is not None and
                            hasattr(i, "center_tap_perct_N_2") and
                            i.center_tap_perct_N_2 is not None and
                            hasattr(i, "center_tap_perct_1_2") and
                            i.center_tap_perct_1_2 is not None):
                    ...
                    if new_customer_load_string != "":
                        customer_load_string_list.append(
                            new_customer_load_string)
                    if new_load_string != "":
