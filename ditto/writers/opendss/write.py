    ...
    **Output file names:**
        ...
        for i in model.models:
            ...
            if isinstance(i, Node):
                ...
                if (hasattr(i, "name") and
                        i.name is not None) and (hasattr(i, "positions") and
                                                 i.positions is not None and
                                                 len(i.positions) > 0):
                    if (self.separate_feeders and hasattr(i, "feeder_name") and
                            i.feeder_name is not None):
                        feeder_name = i.feeder_name
                    else:
                        feeder_name = "DEFAULT"
                    if (self.separate_substations and
                            hasattr(i, "substation_name") and
            ...
            for feeder_name in substation_text_map[substation_name]:
                ...
                if txt != "":
                    ...
                    if self.separate_feeders:
                        ...
                        output_redirect = os.path.join(output_redirect,
                                                       feeder_name)
                        if not os.path.exists(output_folder):
                            os.makedirs(output_folder)
            ...
            if isinstance(i, PowerTransformer):
                ...
                if hasattr(i, "windings") and i.windings is not None:
                    ...
                    for winding in i.windings:
                        if (hasattr(winding, "phase_windings") and
                                winding.phase_windings is not None):
                            N_phases.append(len(winding.phase_windings))
                    if len(np.unique(N_phases)) != 1:
                        logger.error(
                            "Did not find the same number of phases accross windings of transformer {name}"
                            .format(name=i.name))

                    try:
                        # phase-phase connection defined with phase=1 even though it's two phase.
                        if (len(i.windings) == 3 and
                                i.windings[0].connection_type is not None and
                                i.windings[0].connection_type == "D"):
                        ...
                        logger.error(
                            "Could not write the number of phases for transformer {name}"
                            .format(name=i.name))
                ...
                if hasattr(i, "windings") and i.windings is not None:
                    ...
                    for cnt, winding in enumerate(i.windings):
                        if (hasattr(winding, "phase_windings") and
                            ...
                            for phase_winding in winding.phase_windings:
                                if (hasattr(phase_winding, "compensator_r") and
                                ...
                                if (hasattr(phase_winding, "compensator_x") and
                        ...
                        for cnt, winding in enumerate(i.windings):
                            ...
                            if (hasattr(winding, "connection_type") and
                                ...
                                if winding.connection_type == "Y":
                                    ...
                                    logger.error(
                                        "Unsupported type of connection {conn} for transformer {name}"
                                        .format(conn=winding.connection_type,
                                                name=i.name))
                            ...
                            if (hasattr(winding, "nominal_voltage") and
                                ...
                                txt += " Kv={kv}".format(
                                    kv=winding.nominal_voltage *
                                    10**-3)  # opendss in kvolts
                                if (not substation_name + "_" + feeder_name
                                        in self._baseKV_feeders_):
                                    self._baseKV_feeders_[substation_name +
                                                          "_" +
                                                          feeder_name] = set()

                                if (winding.nominal_voltage <
                                        300):  # Line-Neutral voltage for 120 V
                                    self._baseKV_.add(winding.nominal_voltage *
                                                      math.sqrt(3) * 10**-3)
                                    self._baseKV_feeders_[
                                        substation_name + "_" +
                                        feeder_name].add(
                            ...
                            if (hasattr(winding, "emergency_power") and
                                    winding.emergency_power is not None):
                                txt += " EmergHKVA={}".format(
                                    winding.emergency_power *
                                    10**-3)  # opendss in kWatts
                            ...
                            if (hasattr(winding, "phase_windings") and
                                ...
                                if len(winding.phase_windings) != 3:
                                    ...
                                    if (winding.connection_type == "D" and
                                        ...
                                        if self.phase_mapping(
                                                phase_winding.phase) == 1:
                                            txt += ".2"
                                        if self.phase_mapping(
                                                phase_winding.phase) == 2:
                                            txt += ".3"
                                        if self.phase_mapping(
                                                phase_winding.phase) == 3:
                                            txt += ".1"
                            ...
                            if (hasattr(winding, "phase_windings") and
                                ...
                                if (self.write_taps and
                                        hasattr(winding.phase_windings[0],
                                                "tap_position") and
                                        winding.phase_windings[0].tap_position
                                        is not None):
                                    txt += " Tap={tap}".format(
                                        tap=winding.phase_windings[0].
                                        tap_position)

                        if hasattr(i,
                                   "reactances") and i.reactances is not None:
                            ...
                            if isinstance(i.reactances, list):
                                if len(i.reactances) != 1:
                                    logger.error(
                                        "Number of reactances incorrect for transformer {name}. Expected 1, got {N}"
                                        .format(name=i.name,
                                                N=len(i.reactances)))
                                else:
                                    txt += " XHL={reac}".format(
                            ...
                            # If it is not a list, maybe it was entered as a scalar, but should not be that way....
                                ...
                                logger.error(
                                    "Reactances not understood for transformer {name}."
                                    .format(name=i.name))
                    ...
                    if len(i.windings) == 3:
                        ...
                        if hasattr(i,
                            ...
                            if (isinstance(i.reactances, list) and
                                    len(i.reactances) == 3):
                                ...
                                logger.error(
                                    "Wrong number of reactances for transformer {name}"
                                    .format(name=i.name))
                        else:
                ...
                if txt != "":
                    ...
                    if self.separate_substations and self.separate_feeders:
                        ...
                        self.substations_redirect[substation_name].append(
                            self.output_filenames["transformers"])
                    if self.separate_feeders:
                        combined_feeder_sub = os.path.join(
    ...
    def write_storages(self, model):
        ...
        for i in model.models:
            if isinstance(i, Storage):
                ...
                # Phases
                if hasattr(i,
                           "phase_storages") and i.phase_storages is not None:
                    txt += " phases={N_phases}".format(
                        N_phases=len(i.phase_storages))

                    # kW (Need to sum over the phase_storage elements)
                    if sum([1 for phs in i.phase_storages if phs.p is None
                           ]) == 0:
                        p_tot = sum([phs.p for phs in i.phase_storages])
                        txt += " kW={kW}".format(kW=p_tot *
                                                 10**-3)  # DiTTo in watts

                        # Power factor
                        if sum([1 for phs in i.phase_storages if phs.q is None
                               ]) == 0:
                            q_tot = sum([phs.q for phs in i.phase_storages])
                            if q_tot != 0 and p_tot != 0:
                                pf = float(p_tot) / math.sqrt(p_tot**2 +
                                                              q_tot**2)
                ...
                if (hasattr(i, "connecting_element") and
                    ...
                    if (hasattr(i, "phase_storages") and
                            i.phase_storages is not None and
                            len(i.phase_storages) > 0):
                        for phase_storage in i.phase_storages:
                            txt += "." + str(
                                self.phase_mapping(phase_storage.phase))

                # nominal_voltage
                if hasattr(i,
                           "nominal_voltage") and i.nominal_voltage is not None:
                    txt += " kV={volt}".format(volt=i.nominal_voltage *
                                               10**-3)  # DiTTo in volts
                    if not substation_name + "_" + feeder_name in self._baseKV_feeders_:
                        self._baseKV_feeders_[substation_name + "_" +
                                              feeder_name] = set()
                    if i.nominal_voltage < 300:  # Line-Neutral voltage for 120 V
                        self._baseKV_.add(i.nominal_voltage * math.sqrt(3) *
                                          10**-3)
                        self._baseKV_feeders_[substation_name + "_" +
                                              feeder_name].add(
                                                  i.nominal_voltage *
                    ...
                    if hasattr(i,
                               "active_rating") and i.active_rating is not None:
                        pf_local = 1.0
                        if i.power_factor is not None:
                            pf_local = abs(i.power_factor)
                        txt += " kVA={kva}".format(kva=i.active_rating /
                                                   pf_local *
                                                   10**-3)  # DiTTo in watts

                # rated_power
                if hasattr(i, "rated_power") and i.rated_power is not None:
                    txt += " kWRated={kW}".format(kW=i.rated_power *
                                                  10**-3)  # DiTTo in watts
        ...
        for i in model.models:
            if isinstance(i, Photovoltaic):
                ...
                if substation_name + "_" + feeder_name in feeder_voltvar_map:
                    voltvar_nodes = feeder_voltvar_map[substation_name + "_" +
                                                       feeder_name]

                if substation_name + "_" + feeder_name in feeder_voltwatt_map:
                    voltwatt_nodes = feeder_voltwatt_map[substation_name + "_" +
                                                         feeder_name]
                ...
                if hasattr(i,
                    ...
                    if i.nominal_voltage < 300:
                        txt += " kV={kV}".format(kV=i.nominal_voltage *
                                                 math.sqrt(3) *
                                                 10**-3)  # DiTTo in volts
                    else:
                        txt += " kV={kV}".format(kV=i.nominal_voltage *
                    ...
                    if not substation_name + "_" + feeder_name in self._baseKV_feeders_:
                        self._baseKV_feeders_[substation_name + "_" +
                                              feeder_name] = set()
                    if (i.nominal_voltage <
                            300):  # Line-Neutral voltage for 120 V (i.e. 240V)
                        self._baseKV_.add(i.nominal_voltage * math.sqrt(3) *
                                          10**-3)
                        self._baseKV_feeders_[substation_name + "_" +
                                              feeder_name].add(
                    ...
                    if (hasattr(parent, "nominal_voltage") and
                            parent.nominal_voltage is not None):
                        if parent.nominal_voltage < 300:
                            txt += " kV={kV}".format(kV=parent.nominal_voltage *
                                                     math.sqrt(3) *
                                                     10**-3)  # DiTTo in volts
                        else:
                            txt += " kV={kV}".format(kV=parent.nominal_voltage *
                        ...
                        if (not substation_name + "_" + feeder_name
                            ...
                            self._baseKV_feeders_[substation_name + "_" +
                                                  feeder_name] = set()
                        if (parent.nominal_voltage <
                                300):  # Line-Line voltage for 120 V (i.e. 240V)
                            self._baseKV_.add(parent.nominal_voltage *
                                              math.sqrt(3) * 10**-3)
                            self._baseKV_feeders_[substation_name + "_" +
                                                  feeder_name].add(
                                                      parent.nominal_voltage *
                                                      2 * 10**-3)
                        else:
                ...
                if hasattr(i, "active_rating") and i.active_rating is not None:
                    ...
                    if i.power_factor is not None:
                        pf_local = abs(i.power_factor)
                    txt += " kVA={kva}".format(kva=i.active_rating / pf_local *
                                               10**-3)  # DiTTo in watts

                    if not (hasattr(i, "rated_power") and
                            i.rated_power is not None):
                        txt += " Pmpp={kw}".format(
                            kw=i.active_rating * pf_local * 1.1 * 10**
                ...
                if hasattr(i,
                           "reactive_rating") and i.reactive_rating is not None:
                    txt += " kvarlimit={kvar}".format(
                        kvar=i.reactive_rating * 10**
                        -3  # Set the inverter to be oversized by 10% if active rating not specified
                    )  # DiTTo in watts

                # connection type
                if hasattr(i,
                           "connection_type") and i.connection_type is not None:
                    mapps = {"D": "delta", "Y": "wye"}
                    if i.connection_type in mapps:
                        txt += " conn={conn}".format(
                            conn=mapps[i.connection_type])
                    else:
                        raise NotImplementedError(
                            "Connection {conn} for PV systems is currently not supported."
                            .format(conn=i.connection_type))

                # cutout_percent
                if hasattr(i,
                           "cutout_percent") and i.cutout_percent is not None:
                ...
                if hasattr(i, "control_type") and (
                        i.control_type is None or i.control_type
                        == "powerfactor"):  # use powerfactor as default mode
                    if hasattr(i,
                               "power_factor") and i.power_factor is not None:
                        txt += " Model=1 pf={power_factor}".format(
                            power_factor=i.power_factor)

                if (hasattr(i, "control_type") and
                        i.control_type is not None and
                        i.control_type == "voltwatt"):
                    txt += " Model=1 kvar=0"
                    voltwatt_nodes.add(i.name)

                if (hasattr(i, "control_type") and
                        i.control_type is not None and
                        i.control_type == "voltvar"):
                    txt += " Model=1 kvar=0"
                    voltvar_nodes.add(i.name)

                if (hasattr(i, "timeseries") and i.timeseries is not None and
                        len(i.timeseries) > 0):
                    txt += " irradiance=1"
                    for ts in i.timeseries:
                        if (hasattr(ts, "data_location") and
                                ts.data_location is not None and
                                os.path.isfile(ts.data_location)):
                            filename = self.timeseries_datasets[
                                substation_name + "_" +
                                feeder_name][ts.data_location]
                ...
                txt += "\n"
                feeder_text_map[substation_name + "_" + feeder_name] = txt
                feeder_voltvar_map[substation_name + "_" +
                                   feeder_name] = voltvar_nodes
                feeder_voltwatt_map[substation_name + "_" +
                                    feeder_name] = voltwatt_nodes
            ...
            for feeder_name in substation_text_map[substation_name]:
                ...
                if len(voltvar_nodes) > 0:
                    inv_txt += "New XYCurve.VoltVarCurve_{loc} npts=6 Yarray=(1.0,1.0,0.0,0.0,-1.0,-1.0) Xarray=(0.5,0.93,0.97,1.03,1.06,1.5)\n\n".format(
                        loc=substation_name + "_" +
                        feeder_name)  # Default voltvar curve used
                ...
                if len(voltwatt_nodes) > 0:
                    inv_txt += "New XYCurve.VoltWattCurve_{loc} npts=4  Yarray=(1.0,1.0,0.0,0.0) XArray=(0.5,1.06,1.1,1.5)\n\n".format(
                        loc=substation_name + "_" +
                        feeder_name)  # Default volt-watt curve used
        ...
        for i in model.models:
            if isinstance(i, Timeseries):
                ...
                if substation_name + "_" + feeder_name not in self.timeseries_datasets:
                    self.timeseries_datasets[substation_name + "_" +
                                             feeder_name] = {}

                if (hasattr(i, "data_location") and
                        i.data_location is not None and
                        i.data_label is not None and
                    (i.scale_factor is None or i.scale_factor == 1)):
                    filename = i.data_label
                    location = i.data_location
                    if (
                            i.data_location
                            in self.timeseries_datasets[substation_name + "_" +
                                                        feeder_name] and
                    ...
                    if (
                            npoints == 24 or npoints == 24 * 60 or
                            npoints == 24 * 60 * 60
                    ...
                    self.timeseries_datasets[substation_name + "_" +
                                             feeder_name][
                                                 i.data_location] = filename

                elif (hasattr(i, "data_location") and
                      i.data_location is not None and
                      i.data_label is not None and
                      i.scale_factor is not None and i.scale_factor != 1):
                    filename = i.data_label + "_scaled"
                    scaled_data_location = (
                        i.data_location[:-4] + "__scaled%s" %
                        (str(int((i.scale_factor) * 100)).zfill(3)) +
                        i.data_location[-4:])
                    if (
                            i.data_location
                            in self.timeseries_datasets[substation_name + "_" +
        ...
        for i in model.models:
            if isinstance(i, Load):
                ...
                if hasattr(i, "phase_loads") and i.phase_loads:
                    ...
                    for phase_load in i.phase_loads:
                        if hasattr(phase_load,
                                   "p") and phase_load.p is not None:
                ...
                if hasattr(i, "phase_loads") and i.phase_loads:
                    for phase_load in i.phase_loads:
                        if hasattr(phase_load,
                                   "q") and phase_load.q is not None:
                ...
                if hasattr(i, "phase_loads") and i.phase_loads:
                    ...
                    for phase_load in i.phase_loads:
                        ...
                        # ZIP load model
                        if (hasattr(phase_load, "use_zip") and
                                phase_load.use_zip is not None):
                            if phase_load.use_zip:

                                # Get the coefficients
                                if ((hasattr(i, "ppercentimpedance") and
                                     i.ppercentimpedance is not None) and
                                    (hasattr(i, "qpercentimpedance") and
                                     i.qpercentimpedance is not None) and
                                    (hasattr(i, "ppercentcurrent") and
                                     i.ppercentcurrent is not None) and
                                    (hasattr(i, "qpercentcurrent") and
                                     i.qpercentcurrent is not None) and
                                    (hasattr(i, "ppercentpower") and
                                     i.ppercentpower is not None) and
                                    (hasattr(i, "qpercentpower") and
                                     i.qpercentpower is not None)):
                ...
                if hasattr(i, "timeseries") and i.timeseries is not None:
                    for ts in i.timeseries:
                        ...
                        if (hasattr(ts, "data_location") and
                                ...
                                ts.data_location is not None):
                            filename = self.timeseries_datasets[
                                substation + "_" + feeder][ts.data_location]
                            txt += " {ts_format}={filename}".format(
                                ts_format=self.timeseries_format[filename],
                                filename=filename,
                            )
        ...
        for i in model.models:
            if isinstance(i, Regulator):
                ...
                if hasattr(i, "connected_transformer"):
                    ...
                    # Otherwise, we have to create a new transformer and write it to the transformers file
                        ...
                        transfo_name = "trans_{}".format(
                            i.name)  # Maybe not the best naming convention....
                        transfo_creation_string += transfo_name

                        # Number of Phases
                        if hasattr(i, "windings") and i.windings is not None:
                            if (hasattr(i.windings[0], "phase_windings") and
                                    i.windings[0].phase_windings is not None):
                                try:
                        ...
                        if hasattr(i, "windings") and i.windings is not None:
                            ...
                            for w, winding in enumerate(i.windings):
                                ...
                                ) and i.windings[w].connection_type in [
                                        "Y", "D", "Z"
                                ]:
                                    mapp = {
                                        "Y": "Wye",
                                ...
                                if hasattr(i.windings[w], "nominal_voltage"):
                                    ...
                                    if (not substation_name + "_" + feeder_name
                                        ...
                                        self._baseKV_feeders_[
                                            substation_name + "_" +
                                            feeder_name] = set()
                                    if (i.windings[w].nominal_voltage < 300
                        ...
                        if hasattr(i, "windings") and i.windings is not None:
                            kvas = " kvas=("
                            for w, winding in enumerate(i.windings):
                                if (hasattr(i.windings[w], "rated_power") and
                                        i.windings[w].rated_power is not None):
                                    kvas += (str(i.windings[w].rated_power *
                                                 10**-3) + ", ")
                            kvas = kvas[:-2]
                            kvas += ")"
                        ...
                        # emergency_power
                        if hasattr(i, "windings") and i.windings is not None:
                            if (hasattr(i.windings[0], "emergency_power") and
                                    i.windings[0].emergency_power is not None):
                        ...
                        if hasattr(i,
                            ...
                            try:
                                ...
                                logger.warning(
                                    "Could not extract XHL from regulator {name}"
                                    .format(name=i.name))
                            # XLT:
                            try:
                                ...
                                logger.warning(
                                    "Could not extract XLT from regulator {name}"
                                    .format(name=i.name))
                            # XHT:
                            try:
                                ...
                                logger.warning(
                                    "Could not extract XHT from regulator {name}"
                                    .format(name=i.name))
                ...
                if hasattr(i, "bandwidth") and i.bandwidth is not None:
                    txt += " band={b}".format(
                        b=i.bandwidth *
                        1.2)  # The bandwidth is operated at 120 V
                ...
                if hasattr(i, "pt_phase") and i.pt_phase is not None:
                    txt += " Ptphase={PT}".format(
                        PT=self.phase_mapping(i.pt_phase))
                ...
                if hasattr(i, "setpoint") and i.setpoint is not None:
                    txt += " vreg = {setp}".format(setp=i.setpoint / 100.0 *
                                                   120)
                    ...
                    if "X" in self.compensator[i.name]:
                        if len(self.compensator[i.name]["X"]) == 1:
                            ...
                            logger.warning(
                                ...
                                .format(name=i.connected_transformer,
                                        name2=i.name))
                            txt += " X={x}".format(
                                x=list(self.compensator[i.name]["X"])[0])
                ...
                transfo_creation_string_map[
                    substation_name + "_" +
                    feeder_name] = transfo_creation_string
            ...
            if isinstance(i, Capacitor):
                ...
                if i.connecting_element is not None:
                    ...
                    if (hasattr(i, "phase_capacitors") and
                            i.phase_capacitors is not None and
                            len(i.phase_capacitors) != 3):
                ...
                if hasattr(
                        i,
                        "phase_capacitors") and i.phase_capacitors is not None:
                ...
                if hasattr(i,
                    ...
                    if i.connection_type == "Y":
                        ...
                        logger.error(
                            "Unknown connection type in capacitor {name}".
                            format(name=i.name))
                    ...
                    for phase_capacitor in i.phase_capacitors:
                        if (hasattr(phase_capacitor, "var") and
                            ...
                            try:
                                ...
                                logger.error(
                                    "Cannot compute Var of capacitor {name}".
                                    format(name=name))
                ...
                if create_capcontrol:
                    ...
                    # Element (CONTROL)
                    if (hasattr(i, "measuring_element") and
                            i.measuring_element is not None):
        ...
        for i in model.models:
            if isinstance(i, Line):
                ...
                if hasattr(i, "length") and i.length is not None:
                    txt += " Length={length}".format(length=max(
                        0.001, self.convert_from_meters(np.real(i.length),
                                                        u"km")))
                ...
                if hasattr(i, "from_element") and i.from_element is not None:
                    ...
                    if hasattr(i, "wires") and i.wires is not None:
                        for wire in i.wires:
                            if (hasattr(wire, "phase") and
                                    wire.phase is not None and
                                    wire.phase not in ["N", "N1", "N2"]):
                                txt += ".{p}".format(
                                    p=self.phase_mapping(wire.phase))
                ...
                if (hasattr(i, "is_switch") and
                        i.is_switch == 1) or (hasattr(i, "is_breaker") and
                                              i.is_breaker == 1):
                    txt += " switch=y"
                else:
                    txt += " switch=n"
                ...
                if hasattr(
                        i,
                        "wires") and i.wires is not None and len(i.wires) > 0:
                    closed_phase = np.sort([
                        wire.phase
                        for wire in i.wires
                        if (wire.is_open == 0 or wire.is_open is None) and
                        wire.phase is not None and
                        wire.phase not in ["N", "N1", "N2"]
                    ])
    ...
    def write_wiredata(self,
                        ...
                        if len(parsed_wire) > 0:
                            ...
                            if wire.nameclass is not None:
                                ...
                                # exactly the one we currently have
                                    ...
                                    if self.all_wires[
                                            wire.nameclass] != parsed_wire:
                                        self.all_wires[wire.nameclass + "_" +
                                                       str(cnt)] = parsed_wire
                                        wire.nameclass = wire.nameclass + "_" + str(
                                            cnt)
                                        cnt += 1
                        ...
                        if len(parsed_cable) > 0:
                            ...
                            if wire.nameclass is not None:
                                ...
                                if wire.nameclass not in self.all_cables:
                                    self.all_cables[
                                        wire.nameclass] = parsed_cable
                                # Otherwise, there is nothing to do unless the dictionary we previously has is not
                                # exactly the one we currently have
                                else:
                                    if self.all_cables[
                                            wire.nameclass] != parsed_cable:
                                        self.all_cables[wire.nameclass + "_" +
                                                        str(cnt)] = parsed_cable
                                        wire.nameclass = wire.nameclass + "_" + str(
                                            cnt)
                                        cnt += 1
                            # If we don't have a nameclass, we use fake names "cncable_1", "cncable_2"...
                                ...
                                for k, v in self.all_cables.items():
                                    if parsed_cable == v:
                                        ...
                                        wire.nameclass = k
                                if not cable_found:
                                    self.all_cables["CNCable_{n}".format(
                                        n=cnt)] = parsed_cable
        ...
        if len(self.all_wires) > 0:
            fp = open(
                os.path.join(output_folder, self.output_filenames["wiredata"]),
                "w")

            if (self.separate_substations and self.separate_feeders and
                    feeder_name is not None and substation_name is not None):
                if substation_name not in self.substations_redirect:
                    self.substations_redirect[substation_name] = []
                self.substations_redirect[substation_name].append(
                    os.path.join(feeder_name,
        ...
        if len(self.all_cables) > 0:
            fp = open(
                os.path.join(output_folder, self.output_filenames["CNDATA"]),
                "w")
    ...
    def write_linegeometry(self,
                    ...
                    if i.nameclass is not None:
                        if i.nameclass not in self.all_geometries:
                            ...
                            if self.all_geometries[i.nameclass] != parsed_line:
                                self.all_geometries[i.nameclass + "_" +
                                                    str(cpt)] = parsed_line
                        ...
                        if not geometry_found:
                            self.all_geometries["Geometry_{n}".format(
                                n=cpt)] = parsed_line
        ...
        if len(self.all_geometries) > 0:
            ...
            fp = open(
                os.path.join(output_folder,
                             self.output_filenames["linegeometry"]), "w")
            if (self.separate_substations and self.separate_feeders and
                    substation_name is not None and feeder_name is not None):
                if substation_name not in self.substations_redirect:
                    self.substations_redirect[substation_name] = []
                self.substations_redirect[substation_name].append(
                    os.path.join(feeder_name,
            ...
            if isinstance(i, Line):
                ...
                if len(parsed_line) > 0:
                    ...
                    if substation_name + "_" + feeder_name in feeder_text_map:
                        txt = feeder_text_map[substation_name + "_" +
                                              feeder_name]
                    substation_feeder_lookup[substation_name + "_" +
                                             feeder_name] = (
                                                 substation_name,
                                                 feeder_name,
                                             )
                    ...
                    if i.nameclass is not None:
                        ...
                        if nameclass_phase not in self.all_linecodes:
                            ...
                            if self.all_linecodes[
                                    nameclass_phase] != parsed_line:
                                found_subnumber = False
                                for j in range(cnt):
                                    if (nameclass_phase + "_" + str(j)
                                            in self.all_linecodes):
                                        i.nameclass = nameclass_phase + "_" + str(
                                            j)
                                ...
                                if not found_subnumber:
                                    self.all_linecodes[nameclass_phase + "_" +
                                                       str(cnt)] = parsed_line
                                    txt[nameclass_phase + "_" +
                                        str(cnt)] = parsed_line
                                    i.nameclass = nameclass_phase + "_" + str(
                                        cnt)
                                    cnt += 1
                        ...
                        if not linecode_found:
                            ...
                            if hasattr(
                                    i,
                                    "line_type") and i.line_type == "overhead":
                                nameclass += "OH_"

                            if hasattr(i, "line_type"
                                      ) and i.line_type == "underground":
                                nameclass += "UG_"
                            self.all_linecodes["{class_}Code{N}".format(
                                class_=nameclass, N=cnt)] = parsed_line
                            txt["{class_}Code{N}".format(class_=nameclass,
                                                         N=cnt)] = parsed_line
            ...
            for feeder_name in substation_text_map[substation_name]:
                ...
                if len(txt) != 0:
                    ...
                    for linecode_name, linecode_data in txt.items():
                        fp.write(
                            "New Linecode.{name}".format(name=linecode_name))
    ...
    def parse_line(self, line):
        ...
        R = None
        X = None
        if (hasattr(line, "impedance_matrix") and
                line.impedance_matrix is not None and
                line.impedance_matrix != []):
        ...
        elif ((hasattr(line, "is_switch") and line.is_switch) or
              (hasattr(line, "is_breaker") and line.is_breaker) or
              (hasattr(line, "is_fuse") and line.is_fuse) or
              (hasattr(line, "is_recloser") and line.is_recloser) and
              "nphases" in result):
            X = [[0
                  for i in range(result["nphases"])]
                 for j in range(result["nphases"])]
            for i in range(result["nphases"]):
                X[i][i] = 0.00000001
            R = [[0
                  for i in range(result["nphases"])]
                ...
                for elt in row:
                    result["Rmatrix"] += "{e} ".format(
                        e=self.convert_from_meters(
                            np.real(elt), uni, inverse=True))
                result["Rmatrix"] += "| "
            result["Rmatrix"] = result[
                "Rmatrix"][:-2]  # Remove the last "| " since we do not need it
            result["Rmatrix"] += ")"
                ...
                for elt in row:
                    result["Xmatrix"] += "{e} ".format(
                        e=self.convert_from_meters(
                            np.real(elt), uni, inverse=True))
                result["Xmatrix"] += "| "
            result["Xmatrix"] = result[
                "Xmatrix"][:-2]  # Remove the last "| " since we do not need it
            result["Xmatrix"] += ")"

        if (hasattr(line, "capacitance_matrix") and
                line.capacitance_matrix is not None and
                line.capacitance_matrix != []):
                ...
                for elt in row:
                    result["Cmatrix"] += "{e} ".format(
                        e=self.convert_from_meters(
                            np.real(elt), uni, inverse=True))
                result["Cmatrix"] += "| "
            result["Cmatrix"] = result[
                "Cmatrix"][:-2]  # Remove the last "| " since we do not need it
            result["Cmatrix"] += ")"

        # Ampacity
        if (hasattr(line, "wires") and line.wires is not None and
                len(line.wires) > 0 and hasattr(line.wires[0], "ampacity") and
                line.wires[0].ampacity is not None):
            result["normamps"] = line.wires[0].ampacity

        # Emergency ampacity
        if (hasattr(line, "wires") and line.wires is not None and
                len(line.wires) > 0 and
                hasattr(line.wires[0], "emergency_ampacity") and
                line.wires[0].emergency_ampacity is not None):
    ...
    def parse_cable(self, wire):
        ...
        result = {}
        # Insulator thickness
        if (hasattr(wire, "insulation_thickness") and
                wire.insulation_thickness is not None):
        ...
        if (hasattr(wire, "concentric_neutral_nstrand") and
                wire.concentric_neutral_nstrand is not None):
            result["k"] = wire.concentric_neutral_nstrand

        # Diameter of the neutral strands
        if (hasattr(wire, "concentric_neutral_diameter") and
                wire.concentric_neutral_diameter is not None):
            result["DiaStrand"] = wire.concentric_neutral_diameter

        # Resistance of the neutral strand
        if (hasattr(wire, "concentric_neutral_resistance") and
                wire.concentric_neutral_resistance is not None):
        ...
        if (hasattr(wire, "concentric_neutral_outside_diameter") and
                wire.concentric_neutral_outside_diameter is not None):
        ...
        if (hasattr(wire, "concentric_neutral_gmr") and
                wire.concentric_neutral_gmr is not None):
    ...
    def parse_wire(self, wire):
        ...
        if hasattr(
                wire,
                "emergency_ampacity") and wire.emergency_ampacity is not None:
    ...
    def parse_line_geometry(self, line):
        ...
        for cond, wire in enumerate(wire_list):
            ...
            if wire.nameclass in self.all_wires:
                ...
                raise ValueError(
                    "Wire {name} not found.".format(name=wire.nameclass))
            ...
            if (hasattr(wire, "emergency_ampacity") and
                ...
                result["conductor_list"][-1][
                    "Emergamps"] = wire.emergency_ampacity
    ...
    def write_master_file(self, model):
        ...
        with open(
                os.path.join(self.output_path, self.output_filenames["master"]),
                "w") as fp:
            fp.write("Clear\n\nNew Circuit.Full_Network ")
            for obj in model.models:
                if (isinstance(obj, PowerSource) and obj.is_sourcebus
                        == 1):  # For RNM datasets only one source exists.
                    if "_src" in obj.name:
                        cleaned_name = obj.name[:-4]
                    else:
                        cleaned_name = obj.name
                    if (hasattr(obj, "connecting_element") and
                            obj.connecting_element is not None):
                        fp.write("bus1={name} pu={pu}".format(
                            name=obj.connecting_element, pu=obj.per_unit))
                    else:
                        logger.warning(
                            "No valid name for connecting element of source {}. Using name of the source instead..."
                            .format(cleaned_name))
                        fp.write("bus1={name} pu={pu}".format(name=cleaned_name,
                                                              pu=obj.per_unit))

                    if (hasattr(obj, "nominal_voltage") and
                            obj.nominal_voltage is not None):
                        fp.write(
                            " basekV={volt}".format(volt=obj.nominal_voltage *
                                                    10**-3))  # DiTTo in volts

                    if (hasattr(obj, "positive_sequence_impedance") and
                            obj.positive_sequence_impedance is not None):
                        R1 = obj.positive_sequence_impedance.real
                        X1 = obj.positive_sequence_impedance.imag
                        fp.write(" R1={R1} X1={X1}".format(
                            R1=self.float_to_str(R1), X1=self.float_to_str(X1)))

                    if (hasattr(obj, "zero_sequence_impedance") and
                            obj.zero_sequence_impedance is not None):
                        R0 = obj.zero_sequence_impedance.real
                        X0 = obj.zero_sequence_impedance.imag
                        fp.write(" R0={R0} X0={X0}".format(
            ...
            if self.output_filenames["transformers"] in self.files_to_redirect:
                fp.write("Redirect {f}\n".format(
                    f=self.output_filenames["transformers"]))
                self.files_to_redirect.remove(
                    self.output_filenames["transformers"])
            ...
            for file in self.files_to_redirect:
                if (file[-1 * len(self.output_filenames["buses"]):] !=
                        self.output_filenames["buses"]):
        ...
        for i in model.models:
            if isinstance(i, Node) and i.is_substation_connection:
                ...
                with open(
                    ...
                    if (substation_name in self.substations_redirect and
                            feeder_name == ""):  # i.e. it's a substation
                        fp.write(
                            "Clear\n\nNew Circuit.substation_{name} ".format(
                                name=i.name))

                    if (os.path.join(substation_name, feeder_name)
                            in self.feeders_redirect and not os.path.join(
                                substation_name, feeder_name).strip("/")
                            in self.substations_redirect):  # i.e. it's a feeder
                        fp.write("Clear\n\nNew Circuit.feeder_{name} ".format(
                            name=i.name))
                    fp.write("bus1={name} pu={pu}".format(name=i.name,
                                                          pu=i.setpoint))
                    if hasattr(i, "nominal_voltage"
                              ) and i.nominal_voltage is not None:
                        fp.write(" basekV={volt}".format(
                            volt=i.nominal_voltage * 10**-3))  # DiTTo in volts
                    fp.write(" R1={R1} X1={X1}".format(
                        R1=0.00001, X1=0.00001))  # Infinite source bus
                    fp.write(" R0={R0} X0={X0}".format(
                        R0=0.00001, X0=0.00001))  # Infinite source bus
                    fp.write("\n\n")
                    if (substation_name in self.substations_redirect and
                            feeder_name == ""):  # i.e. it's a substation
                        for element in self.substations_redirect[
                                substation_name]:
                    ...
                    if (os.path.join(substation_name, feeder_name)
                            in self.feeders_redirect and not os.path.join(
                                substation_name, feeder_name).strip("/")
                            in self.substations_redirect):  # i.e. it's a feeder
                        for element in self.feeders_redirect[os.path.join(
                                substation_name, feeder_name)]:
                            fp.write("Redirect " + element + "\n")
                    if i.substation_name + "_" + i.feeder_name in self._baseKV_feeders_:
                        _baseKV_list_ = list(
                            self._baseKV_feeders_[i.substation_name + "_" +
                                                  i.feeder_name])
                    else:
                        _baseKV_list_ = []
                    _baseKV_list_ = sorted(_baseKV_list_)
