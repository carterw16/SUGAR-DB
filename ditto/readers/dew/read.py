...
"""
        ...
        for row in all_rows:
                    ...
                    if entries[0] == "$CMP," and entries[18] == "16,":
                        ...
                        while True:
                            ...
                            if row_frm1_tf[0] == "$CMP," and row_frm1_tf[
                                ...
                                row_frm3_tf = row_frm2_tf.split()
                                try:
                                    api_transformer.to_element = row_frm3_tf[1][
                                        1:-2]
                                except AttributeError:
                                    pass
                                break
            ...
            if entries[0] == "$CMP," and (
                ...
                Yabc_red = Yabc_red * 1000 / (Cap_Freq.imag
                                             )  # multiply 1000 to nF
                #                    logger.debug('--------------')
                #                    logger.debug(Yabc_red)
