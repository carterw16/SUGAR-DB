...
class Reader:
    ...
    def parse(self, model, inputfile, databasepath):
                ...
                while True:
                    ...
                    if row_node1[0] == "$CMP," and row_node1[1] == node_path:
                        if row_node1[18] == "16,":
                            ...
                            voltage_node = (
                                float(PTSUB_DPHABKV[int(row_node1[6][:-1])]) *
                                1000
        ...
        for row in all_rows:
            ...
            if len(entries) > 10 and entries[18] == "513,":
                ...
                if obj_class == "node":
                    ...
                    try:
                        ...
                        position.lat = float(
                            entries[13][:-1])  # X position in EDD DEW
                        position.long = float(
                            entries[14][:-1])  # Y posiiton in EDD
            ...
            if entries[0] == "$CMP," and entries[5] == "22,":
                ...
                if obj_class == "regulator":
                    ...
                    for kk in ph:
                        ...
                        if entries[0] == "$CMP," and entries[5] == "22,":
                            ...
                            while True:
                                ...
                                if row_frm1[0] == "$CMP," and row_frm1[1] == frm:
                                    ...
                                    try:
                                        api_regulator.from_element = row_frm3[
                                            1][1:-2]
                                    except AttributeError:
                                        pass
                                    break
                        if entries[0] == "$CMP," and entries[5] == "22,":
                            ...
                            while True:
                                ...
                                if row_frm1[0] == "$CMP," and row_frm1[1] == frm:
                                    ...
                                    row_frm3 = row_frm2.split()
                                    try:
                                        api_regulator.to_element = row_frm3[1][
                                            1:-2]
                                    except AttributeError:
                                        pass
                                    break
                            ...
                            try:
                                ...
                                api_regulator.highstep = int(
                                    PTXFRM_SNUMSTEPS[PTXFRM_IPTROW.index(
                                        float(iptr))])
                        ...
                        tf_rcfg = APIXFRMCONIDX_STNAM[int(
                            PTXFRM_IXFRMCON[PTXFRM_IPTROW.index(iptr_rwdg)])]
                        ...
                        while True:
                            ...
                            if row_pt2[:9] == "$CMPADDPT" and row_pt1[
                                    1] == "49,":
                                try:
                            ...
                            if row_pt2[:9] == "$CMPADDPT" and row_pt1[
                                ...
                                try:
                                    api_regulator.ct_prim = float(
                                        PTINST_DSECDRATA[PTINST_IPTROW.index(
                                            float(row_pt1[2][:-1]))]) * float(
                                                row_pt1[7][:-1])
                                except AttributeError:
                                    pass
            ...
            if entries[0] == "$CMP," and entries[18] == "16,":
                ...
                for nr in range(nreg):
                    ...
                    if obj_class == "transformer":
                        ...
                        tf_cfg = APIXFRMCONIDX_STNAM[int(
                            PTXFRM_IXFRMCON[PTXFRM_IPTROW.index(iptr_wdg)])]
                        tf_cfg1 = tf_cfg.split(":")
                        prv = PTXFRM_DPRIKV[int(PTXFRM_IPTROW.index(iptr_wdg))]
                        sev = PTXFRM_DSECKV[int(PTXFRM_IPTROW.index(iptr_wdg))]
                        zmag = float(PTXFRM_DISAT0A[int(
                            PTXFRM_IPTROW.index(iptr_wdg))])
                        zang = float(PTXFRM_DVSAT0PC[int(
                            PTXFRM_IPTROW.index(iptr_wdg))])
                        ...
                        for w in range(num_windings):
                            ...
                            if num_windings == 2:
                                if "Y" in tf_cfg1[0 + w]:
                                    ...
                                    vmut = 1
                                if "Delta" in tf_cfg1[0 +
                                                      w] or "Del" in tf_cfg1[0 +
                                                                             w]:
                                    ...
                                    try:
                                        ...
                                        for p in range(len(ph1)):
                                            ...
                                            if ph1 == "C":
                                                tp = 2
                                            phase_windings[
                                                p].tap_position = float(
                                                    row_pwg1[7 + tp][:-1])
                                            logger.debug(
                                                float(row_pwg1[7 + tp][:-1]))
                                            logger.debug("-----")
                                            phase_windings[p].phase = ph1[p]
                                            phase_windings[
                                                p].compensator_r = float(
                                                    row_pwg1[19][:-1])
                                            phase_windings[
                                                p].compensator_x = float(
                                                    row_pwg1[20][:-1])
                                    except AttributeError:
                                        pass
                    ...
                    while True:
                        ...
                        if row_tf[:13] == "$CMPSERIALNUM":
                            ...
                            try:
                                api_transformer.name = row_tf1[1][
                                    1:-2] + "_" + ph1
                            except AttributeError:
                                pass
                    ...
                    try:
                        api_transformer.emergency_power = (
                            float(PTXFRM_DFAVLTMRATKVA[int(
                                PTXFRM_IPTROW.index(iptr_wdg))]) * 10**3
                    ...
                    try:
                        api_transformer.loadloss = (
                            float(PTXFRM_DWINDLOSSW[int(
                                PTXFRM_IPTROW.index(iptr_wdg))]) +
                            float(PTXFRM_DCORELOSSW[int(
                                PTXFRM_IPTROW.index(iptr_wdg))])
                    ...
                    try:
                        api_transformer.normhkva = (float(PTXFRM_DPRIKV[int(
                            PTXFRM_IPTROW.index(iptr_wdg))]) * 10**3
                                                   )  # DiTTo in volt ampere
                    except:
                        pass
                    ...
                    try:
                        api_transformer.noload_loss = (float(
                            PTXFRM_DCORELOSSW[int(PTXFRM_IPTROW.index(
                                iptr_wdg))])) / 1000.0  # DiTTo in volt ampere
                    except:
                        pass
                    ...
                    #                    api_transformer.reactances.append(float(reactance*0.5))   #XHT
                        ...
                        if (PTXFRM_QCOMPEXISTS[int(
                                PTXFRM_IPTROW.index(iptr_wdg))] == 205.0):
                            zmag1 = float(PTXFRM_DISAT1A[int(
                                PTXFRM_IPTROW.index(iptr_wdg))])
                            zang1 = float(PTXFRM_DVSAT1PC[int(
                                PTXFRM_IPTROW.index(iptr_wdg))])
                            zmag2 = float(PTXFRM_DISAT2A[int(
                                PTXFRM_IPTROW.index(iptr_wdg))])
                            zang2 = float(PTXFRM_DVSAT2PC[int(
                                PTXFRM_IPTROW.index(iptr_wdg))])
                            reactance1 = zmag1 * math.sin(math.radians(zang1))
                            reactance2 = zmag2 * math.sin(math.radians(zang2))
                            api_transformer.reactances = []
                            api_transformer.reactances.append(
                                float(reactance1 + reactance2))  # XHL
                            api_transformer.reactances.append(
                                float(reactance2))  # XLT
                            api_transformer.reactances.append(
                                float(reactance2))  # XHT
                        else:
                            api_transformer.reactances = []
                            api_transformer.reactances.append(
                                float(reactance))  # XHL
                            api_transformer.reactances.append(
                                float(reactance * 0.5))  # XLT
                            api_transformer.reactances.append(
                                float(reactance * 0.5))  # XHT
                        #
                        #
                    ...
                    if entries[0] == "$CMP," and entries[18] == "16,":
                        ...
                        while True:
                            ...
                            if row_frm1_ln[0] == "$CMP," and row_frm1_ln[
                                    1] == frm_ln:
                                ...
                                if row_frm1_ln[18] == "513,":
                                    try:
                                        api_transformer.from_element = row_frm3_ln[
                                            1][1:-2]
                                    except AttributeError:
                                        pass
                                    break
                    ...
                    if entries[0] == "$CMP," and entries[18] == "16,":
                        ...
                        while True:
                            ...
                            row_frm_ln = row_frm_ln.strip()
                            row_frm1_ln = row_frm_ln.split()
                            if (row_frm1_ln[0] == "$CMP," and
                                    row_frm1_ln[18] == "513," and
                                    row_frm1_ln[32] == frm_ln):
                                row_frm2_ln = all_rows[iter_frm_ln + 1]
                                row_frm2_ln = row_frm2_ln.strip()
                                row_frm3_ln = row_frm2_ln.split()
                                try:
                                    api_transformer.to_element = row_frm3_ln[1][
                                        1:-2]
                                except AttributeError:
                                    pass
                                break
                            elif (row_frm1_ln[0] == "$CMP," and
                                  row_frm1_ln[18] == "513," and
                                  row_frm1_ln[34] == frm_ln):
                                row_frm2_ln = all_rows[iter_frm_ln + 1]
                                row_frm2_ln = row_frm2_ln.strip()
                                row_frm3_ln = row_frm2_ln.split()
                                try:
            ...
            if entries[0] == "$CMP," and (entries[18] == "32," or
                                          entries[18] == "40,"):
                iter_cap = iter
                ...
                if (PTCAP_SCON[PTCAP_IPTROW.index(iptr_cap)] == 1.0 or
                        PTCAP_SCON[PTCAP_IPTROW.index(iptr_cap)] == 3.0):
                    api_capacitor.connection_type = "Y"
                    api_capacitor.nominal_voltage = (float(
                        (APILEVIDX_DVARLEV[int(
                            PTCAP_IVLEV[PTCAP_IPTROW.index(iptr_cap)])])) *
                                                     10**3)
                ...
                api_capacitor.low = (float(APIRANIDX_DLOWVAL[int(
                    PTCAP_IVRAN[PTCAP_IPTROW.index(iptr_cap)])]) * 1000
                                    )  # cross check
                api_capacitor.high = (float(APIRANIDX_DUPVAL[int(
                    PTCAP_IVRAN[PTCAP_IPTROW.index(iptr_cap)])]) * 1000
                                     )  # cross check
                ...
                for p, p_c in enumerate(ph_c):
                    ...
                    if float(PTCAP_SCON[PTCAP_IPTROW.index(iptr_cap)]) in (
                        ...
                        phase_capacitors[p].var = (float(
                            PTCAP_DRATKVAR[PTCAP_IPTROW.index(iptr_cap)]) *
                                                   10**3) / 3.0
                    else:
                        phase_capacitors[p].var = (float(
                            PTCAP_DRATKVAR[PTCAP_IPTROW.index(iptr_cap)]) *
            ...
            if entries[0] == "$CMP," and (
                    entries[18] == "1," or entries[18] == "65," or
                    entries[18] == "129," or entries[18] == "258," or
                    entries[18] == "2," or entries[18] == "6,"):
                ...
                for pw in range(num_ph + 1):
                    ...
                    if pw >= num_ph:
                        ...
                        if int(entries[5][:-1]) == 8 or int(
                                entries[5][:-1]) == 100:
                            wires[pw].nameclass = PTSWT_STDESC[int(
                                entries[6][:-1])]
                            wires[pw].is_fuse = True
                            wires[pw].resistance = 0.001
                            wires[pw].ampacity = float(PTSWT_DCURTRATA[int(
                                entries[6][:-1])])
                            wires[pw].emergency_ampacity = (
                                float(PTSWT_DCURTRATA[int(entries[6][:-1])]) *
                                1.5)
                        else:
                    ...
                    while True:
                        ...
                        if row_wr[:7] == "$CMPCHN":
                            ...
                            if (int(entries[5][:-1]) == 35 or
                                    int(entries[5][:-1]) == 36 or
                                    int(entries[5][:-1]) == 37 or
                                    int(entries[5][:-1]) == 38):
                                ...
                                if pw >= num_ph:
                                    if int(row_wr1[6][:-1]) == -1:
                                        ...
                                        wires[pw].gmr = None
                                        wires[
                                            pw].ampacity = None  # switches ampacity update it
                                        ...
                                        wires[pw].nameclass = PTLINECOND_STDESC[
                                            int(row_wr1[6][:-1])]
                                        wires[pw].diameter = (
                                            float(PTLINECOND_DRADCONDSUL[int(
                                                row_wr1[6][:-1])]) * 2)
                                        wires[pw].gmr = float(
                                            PTLINECOND_DGMRSUL[int(
                                                row_wr1[6][:-1])])
                                        wires[pw].ampacity = float(
                                            PTLINECOND_DRATAMBTEMP0A[int(
                                                row_wr1[6][:-1])])
                                        wires[pw].emergency_ampacity = float(
                                            PTLINECOND_DRATAMBTEMP1A[int(
                                                row_wr1[6][:-1])])
                                        wires[pw].resistance = float(
                                            PTLINECOND_DROHMPRLUL[int(
                                                row_wr1[6][:-1])]) * float(
                                                    row_wr1[13][:-1])
                                else:
                                    wires[pw].nameclass = PTLINECOND_STDESC[int(
                                        row_wr1[5][:-1])]
                                    wires[pw].diameter = (
                                        float(PTLINECOND_DRADCONDSUL[int(
                                            row_wr1[5][:-1])]) * 2)
                                ...
                                if pw >= num_ph:
                                    if int(row_wr1[6][:-1]) == -1:
                                        ...
                                        wires[pw].nameclass = PTCABCOND_STDESC[
                                            int(row_wr1[6][:-1])]
                                        wires[pw].diameter = (
                                            float(PTCABCOND_DRADCONDSUL[int(
                                                row_wr1[6][:-1])]) * 2)
                                        wires[pw].gmr = float(
                                            PTCABCOND_DGMRSUL[int(
                                                row_wr1[6][:-1])])
                                        wires[pw].resistance = float(
                                            PTCABCOND_DROHMPRLUL[int(
                                                row_wr1[6][:-1])]) * float(
                                                    row_wr1[13][:-1])
                                        if (PTLINESPC_SOVERHEAD[int(
                                                row_wr1[4][:-1])] == 0.0):
                                            wires[pw].ampacity = float(
                                                PTCABCOND_DRATA0[int(
                                                    row_wr1[6][:-1])])
                                            wires[
                                                pw].emergency_ampacity = float(
                                                    PTCABCOND_DRATA0[int(
                                                        row_wr1[5]
                                                        [:-1])])  # not provided
                                        if (PTLINESPC_SOVERHEAD[int(
                                    ...
                                    wires[pw].nameclass = PTCABCOND_STDESC[int(
                                        row_wr1[5][:-1])]
                                    wires[pw].diameter = (
                                        float(PTCABCOND_DRADCONDSUL[int(
                                            row_wr1[5][:-1])]) * 2)
                                    wires[pw].gmr = float(PTCABCOND_DGMRSUL[int(
                                        row_wr1[5][:-1])])
                                    wires[pw].resistance = float(
                                        PTCABCOND_DROHMPRLUL[int(
                                            row_wr1[5][:-1])]) * float(
                            ...
                            if (PTLINESPC_TMUTSPC[int(row_wr1[4][:-1])] == 0.0
                                    or PTLINESPC_TMUTSPC[int(
                                        row_wr1[4][:-1])] == 1.0):
                                if pw >= num_ph:
                                    wires[pw].X = (
                                        float(PTLINESPC_DXNEU[int(
                                            row_wr1[4][:-1])]) * 0.3048 -
                                        float(PTLINESPC_DXPH1ORR1[int(
                                            row_wr1[4][:-1])]) * 0.3048)
                                    wires[pw].Y = (
                                        float(PTLINESPC_DYNEU[int(
                                            row_wr1[4][:-1])]) * 0.3048 -
                                        float(PTLINESPC_DYPH1ORX1[int(
                                            row_wr1[4][:-1])]) * 0.3048)
                                else:
                                    if pw == 0:
                                        wires[pw].X = (
                                    ...
                                    if pw == 1:
                                        wires[pw].X = (
                                            float(PTLINESPC_DXPH2ORR0[int(
                                                row_wr1[4][:-1])]) * 0.3048 -
                                            float(PTLINESPC_DXPH1ORR1[int(
                                                row_wr1[4][:-1])]) * 0.3048)
                                        wires[pw].Y = (
                                            float(PTLINESPC_DYPH2ORX0[int(
                                                row_wr1[4][:-1])]) * 0.3048 -
                                            float(PTLINESPC_DYPH1ORX1[int(
                                                row_wr1[4][:-1])]) * 0.3048)
                                    if pw == 2:
                                        wires[pw].X = (
                                            float(PTLINESPC_DXPH3ORY0[int(
                                                row_wr1[4][:-1])]) * 0.3048 -
                                            float(PTLINESPC_DXPH1ORR1[int(
                                                row_wr1[4][:-1])]) * 0.3048)
                                        wires[pw].Y = (
                                            float(PTLINESPC_DYPH3ORY1[int(
                                                row_wr1[4][:-1])]) * 0.3048 -
                                            float(PTLINESPC_DYPH1ORX1[int(
                                                row_wr1[4][:-1])]) * 0.3048)
                        ...
                        if row_wr[:8] == "$CMPOPER":
                            row_wr = row_wr.strip()
                            row_wr1 = row_wr.split()
                            if (int(entries[5][:-1]) == 8 or
                                    int(entries[5][:-1]) == 100) and (int(
                                        row_wr1[5]) == 1):
                ...
                if (entries[5] == "35," or entries[5] == "36," or
                        entries[5] == "37," or entries[5] == "38," or
                        entries[5] == "39," or entries[5] == "40," or
                        entries[5] == "41," or entries[5] == "41,"):
                    api_line.line_type = "overhead"
                if (entries[5] == "43," or entries[5] == "44," or
                        entries[5] == "45," or entries[5] == "46,"):
                ...
                while True:
                    ...
                    if row_ug[:7] == "$CMPCHN":
                        ...
                        if (int(entries[5][:-1]) == 43 or
                                int(entries[5][:-1]) == 44 or
                                int(entries[5][:-1]) == 45 or
                                int(entries[5][:-1]) == 46):
                            if (PTLINESPC_TMUTSPC[int(row_ug1[4][:-1])] == 0.0
                                    or PTLINESPC_TMUTSPC[int(
                                        row_ug1[4][:-1])] == 1.0):
                                cond_dia1 = (float(PTCABCOND_DRADCONDSUL[int(
                                    row_ug1[5][:-1])]) * 2)
                                cond_dia2 = (float(PTCABCOND_DRADCONDSUL[int(
                                    row_ug1[5][:-1])]) * 2)
                                cond_dia3 = (float(PTCABCOND_DRADCONDSUL[int(
                                    row_ug1[5][:-1])]) * 2)
                                cond_res1 = (float(PTCABCOND_DROHMPRLUL[int(
                                    row_ug1[5][:-1])]) * 5.28)  # LUL TO MILE
                                cond_res2 = (float(PTCABCOND_DROHMPRLUL[int(
                                    row_ug1[5][:-1])]) * 5.28)  # LUL TO MILE
                                cond_res3 = (float(PTCABCOND_DROHMPRLUL[int(
                                    row_ug1[5][:-1])]) * 5.28)  # LUL TO MILE
                                XA = float(PTLINESPC_DXPH1ORR1[int(
                                    row_ug1[4][:-1])])
                                XB = float(PTLINESPC_DXPH2ORR0[int(
                                    row_ug1[4][:-1])])
                                XC = float(PTLINESPC_DXPH3ORY0[int(
                                    row_ug1[4][:-1])])
                                XN = float(PTLINESPC_DXNEU[int(
                                    row_ug1[4][:-1])])
                                permA = float(PTINSULIDX_DRELATIVEPERMIT[int(
                                    PTCABCOND_IINSUL[int(row_ug1[5][:-1])])])
                                if row_ug1[6] == "-1,":
                                    cond_dia7 = 0.0
                                    ...
                                    cond_dia7 = (
                                        float(PTCABCOND_DRADCONDSUL[int(
                                            row_ug1[6][:-1])]) / 12)
                                    cond_res7 = (float(PTCABCOND_DROHMPRLUL[int(
                                        row_ug1[6][:-1])]) * 5.28
                                                )  # LUL TO MILE
                                if (PTCABCOND_TCONCENTNEU[int(row_ug1[5][:-1])]
                                        == 1.0):  # CONCENTRIC NEUTRAL
                                    out_dia1 = float(
                                        PTCABCOND_DDIANEUSTRNDSUL[int(
                                            row_ug1[5][:-1])])
                                    out_dia2 = float(
                                        PTCABCOND_DDIANEUSTRNDSUL[int(
                                            row_ug1[5][:-1])])
                                    out_dia3 = float(
                                        PTCABCOND_DDIANEUSTRNDSUL[int(
                                            row_ug1[5][:-1])])
                                    GMR1 = (float(PTCABCOND_DGMRSUL[int(
                                        row_ug1[5][:-1])]) / 12)
                                    GMR2 = (float(PTCABCOND_DGMRSUL[int(
                                        row_ug1[5][:-1])]) / 12)
                                    GMR3 = (float(PTCABCOND_DGMRSUL[int(
                                        row_ug1[5][:-1])]) / 12)
                                    GMR4C = (
                                        float(PTCABCOND_DNEUSTRNDGMRSUL[int(
                                            row_ug1[5][:-1])]) / 12)
                                    GMR5C = (
                                        float(PTCABCOND_DNEUSTRNDGMRSUL[int(
                                            row_ug1[5][:-1])]) / 12)
                                    ...
                                    GMR6S = 0
                                    cond_dia4 = (
                                        float(PTCABCOND_DRADSTRNDSUL[int(
                                            row_ug1[5][:-1])]) * 2)
                                    cond_dia5 = (
                                        float(PTCABCOND_DRADSTRNDSUL[int(
                                            row_ug1[5][:-1])]) * 2)
                                    cond_dia6 = (
                                        float(PTCABCOND_DRADSTRNDSUL[int(
                                            row_ug1[5][:-1])]) * 2)
                                    cond_res4 = (
                                        float(PTCABCOND_DNEUSTRNDROHM[int(
                                            row_ug1[5][:-1])]) * 5.28)
                                    cond_res5 = (
                                        float(PTCABCOND_DNEUSTRNDROHM[int(
                                            row_ug1[5][:-1])]) * 5.28)
                                    ...
                                    if row_ug1[6] == "-1,":
                                        ...
                                        GMR7 = (float(PTCABCOND_DGMRSUL[int(
                                            row_ug1[6][:-1])]) / 12)
                                        D17 = abs(XN - XA)
                                        D27 = abs(XN - XB)
                                        D37 = abs(XN - XC)
                                elif (PTCABCOND_TCONCENTNEU[int(
                                        row_ug1[5][:-1])] == 0.0
                                     ):  # TAPE SHEILD
                                    out_dia1 = float(
                                        PTCABCOND_DCONDJACKETSUL[int(
                                            row_ug1[5][:-1])])
                                    out_dia2 = float(
                                        PTCABCOND_DCONDJACKETSUL[int(
                                            row_ug1[5][:-1])])
                                    ...
                                    Tape_Thick = float(
                                        PTCABCOND_DDIANEUSTRNDSUL[int(
                                            row_ug1[5][:-1])])
                                    GMR4S = (float(PTCABCOND_DINSULSUL[int(
                                        row_ug1[5][:-1])]) +
                                             Tape_Thick) / 24.0  # recheck this
                                    GMR5S = (float(PTCABCOND_DINSULSUL[int(
                                        row_ug1[5][:-1])]) +
                                             Tape_Thick) / 24.0  # recheck this
                                    GMR6S = (float(PTCABCOND_DINSULSUL[int(
                                        row_ug1[5][:-1])]) +
                                             Tape_Thick) / 24.0  # recheck this
                                    cond_dia4 = 0
                                    cond_dia5 = 0
                                    ...
                                    cond_res4S = (
                                        ...
                                        float(PTCABCOND_DNEUSTRNDROHM[int(
                                            row_ug1[5][:-1])])
                                    ) / (float(PTCABCOND_DINSULSUL[int(
                                        row_ug1[5][:-1])]) * Tape_Thick * 1000)
                                    cond_res5S = (
                                        (7.9385e8) * 0.3048 *
                                        float(PTCABCOND_DNEUSTRNDROHM[int(
                                            row_ug1[5][:-1])])
                                    ...
                                    if row_ug1[6] == "-1,":
                                        ...
                                        sheild_thick4 = float(
                                            PTCABCOND_DDIANEUSTRNDSUL[int(
                                                row_ug1[6][:-1])])
                                        sheild_dia4 = float(PTCABCOND_DINSULSUL[
                                            int(row_ug1[6][:-1])]) + float(
                                                PTCABCOND_DDIANEUSTRNDSUL[int(
                                                    row_ug1[6][:-1])])
                                        # recheck this
                                        cond_res7 = (
                                            float(PTCABCOND_DROHMPRLUL[int(
                                                row_ug1[6][:-1])]) * 5.28)
                                        D17 = abs(XN - XA)
                                        D27 = abs(XN - XB)
                                        D37 = abs(XN - XC)
                                ...
                                if (PTCABCOND_TCONCENTNEU[int(row_ug1[5][:-1])]
                                    ...
                                    zabc = zijcn - zincn * np.linalg.inv(
                                        znncn) * znjcn
                                    Zabc = zabc
                                    As1 * zabc * As
                                    # capacitance calculation
                                    if "A" in ph_w:
                                        if (cond_dia1 == 0 or R14 == 0 or
                                                nue_strands4 == 0):
                                            can = 0
                                        else:
                                            den_aph = math.log(
                                                ...
                                                (nue_strands4) * cond_dia4 /
                                                24.0 / R14)
                                            if den_aph == 0:
                                                can = 0
                                            else:
                                                can = (2.0 * math.pi * 0.01420 *
                                                       permA) / den_aph
                                    else:
                                        can = 0
                                    if "B" in ph_w:
                                        if (cond_dia2 == 0 or R25 == 0 or
                                                nue_strands5 == 0):
                                            cbn = 0
                                        else:
                                            den_bph = math.log(
                                                ...
                                                (nue_strands5) * cond_dia5 /
                                                24.0 / R25)
                                            if den_bph == 0:
                                                cbn = 0
                                            else:
                                                cbn = (2.0 * math.pi * 0.01420 *
                                                       permA) / den_bph
                                    else:
                                        cbn = 0
                                    if "C" in ph_w:
                                        if (cond_dia3 == 0 or R36 == 0 or
                                                nue_strands6 == 0):
                                            ccn = 0
                                        else:
                                            den_cph = math.log(
                                                ...
                                                (nue_strands6) * cond_dia6 /
                                                24.0 / R36)
                                            if den_cph == 0:
                                                ccn = 0
                                            else:
                                                ccn = (2.0 * math.pi * 0.01420 *
                                                       permA) / den_cph
                                    else:
                                        ccn = 0
                                    ...
                                    for i_cn in range(7):
                                        for j_cn in range(7):
                                            if i_cn == j_cn:
                                                ...
                                                if ((i_cn == 0 and j_cn == 3) or
                                                    (i_cn == 1 and j_cn == 4) or
                                                    (i_cn == 2 and j_cn == 5)):
                                                    if GMRS == 0:
                                                        Z[i_cn][j_cn] = complex(
                                                            0.0)
                                    ...
                                    zabc = zijts - zints * np.linalg.inv(
                                        znnts) * znjts
                                    Zabc = zabc
                                    Zabc = Zabc / 1609.34
                                    As1 * zabc * As
                                ...
                                R1 = float(PTLINESPC_DXPH1ORR1[int(
                                    entries[6][:-1])])
                                X1 = float(PTLINESPC_DYPH1ORX1[int(
                                    entries[6][:-1])])
                                R0 = float(PTLINESPC_DXPH2ORR0[int(
                                    entries[6][:-1])])
                                X0 = float(PTLINESPC_DYPH2ORX0[int(
                                    entries[6][:-1])])
                                Y1 = float(PTLINESPC_DYPH3ORY1[int(
                                    entries[6][:-1])])
                                Y0 = float(PTLINESPC_DXPH3ORY0[int(
                                    entries[6][:-1])])
                                if "A" in ph_w:
                                    Zabc[0][0] = (
                                        (complex(R1, X1)) / 1.25) / 0.151515
                                    Yabc[0][0] = (
                                        (complex(0, Y1)) / 1.25) / 0.151515
                                if "B" in ph_w:
                                    Zabc[1][1] = (
                                        (complex(R1, X1)) / 1.25) / 0.151515
                                    Yabc[1][1] = (
                            ...
                            DBE = 0.0
                            DCE = 0.0
                            GMRA_OH = (float(PTLINECOND_DGMRSUL[int(
                                row_ug1[5][:-1])]) / 12.0)
                            GMRB_OH = (float(PTLINECOND_DGMRSUL[int(
                                row_ug1[5][:-1])]) / 12.0)
                            GMRC_OH = (float(PTLINECOND_DGMRSUL[int(
                                row_ug1[5][:-1])]) / 12.0)
                            RESA_OH = (float(PTLINECOND_DROHMPRLUL[int(
                                row_ug1[5][:-1])]) * 5.28)
                            RESB_OH = (float(PTLINECOND_DROHMPRLUL[int(
                                row_ug1[5][:-1])]) * 5.28)
                            RESC_OH = (float(PTLINECOND_DROHMPRLUL[int(
                                row_ug1[5][:-1])]) * 5.28)
                            DIAA = (float(PTLINECOND_DRADCONDSUL[int(
                                row_ug1[5][:-1])]) * 2)
                            DIAB = (float(PTLINECOND_DRADCONDSUL[int(
                                row_ug1[5][:-1])]) * 2)
                            DIAC = (float(PTLINECOND_DRADCONDSUL[int(
                                row_ug1[5][:-1])]) * 2)
                            if (PTLINESPC_TMUTSPC[int(row_ug1[4][:-1])] == 0.0
                                    or PTLINESPC_TMUTSPC[int(
                                        row_ug1[4][:-1])] == 1.0):
                                X1 = float(PTLINESPC_DXPH1ORR1[int(
                                    row_ug1[4][:-1])])
                                X2 = float(PTLINESPC_DXPH2ORR0[int(
                                    row_ug1[4][:-1])])
                                X3 = float(PTLINESPC_DXPH3ORY0[int(
                                    row_ug1[4][:-1])])
                                Y1 = float(PTLINESPC_DYPH1ORX1[int(
                                    row_ug1[4][:-1])])
                                Y2 = float(PTLINESPC_DYPH2ORX0[int(
                                    row_ug1[4][:-1])])
                                Y3 = float(PTLINESPC_DYPH3ORY1[int(
                                    row_ug1[4][:-1])])
                                PH1 = ""
                                PH2 = ""
                                PH3 = ""
                                ...
                                if int(row_ug1[6][:-1]) == -1:
                                    ...
                                    XN = float(PTLINESPC_DXNEU[int(
                                        row_ug1[4][:-1])])
                                    YN = float(PTLINESPC_DYNEU[int(
                                        row_ug1[4][:-1])])
                                DAB = pow((pow(XB - XA, 2) + pow(YB - YA, 2)),
                                          0.5)
                                DAC = pow((pow(XC - XA, 2) + pow(YC - YA, 2)),
                                          0.5)
                                DBC = pow((pow(XC - XB, 2) + pow(YC - YB, 2)),
                                          0.5)
                                DAE = YA
                                DBE = YB
                                DCE = YC
                                DNE = YN
                                DAN = pow((pow(XN - XA, 2) + pow(YN - YA, 2)),
                                          0.5)
                                DBN = pow((pow(XN - XB, 2) + pow(YN - YB, 2)),
                                          0.5)
                                DCN = pow((pow(XN - XC, 2) + pow(YN - YC, 2)),
                                          0.5)
                            if int(row_ug1[6][:-1]) == -1:
                                GMRN_OH = 0
                                RESN_OH = 0
                                ...
                                GMRN_OH = (float(PTLINECOND_DGMRSUL[int(
                                    row_ug1[6][:-1])]) / 12.0)
                                RESN_OH = (float(PTLINECOND_DROHMPRLUL[int(
                                    row_ug1[6][:-1])]) * 5.28)
                                DIAN = (float(PTLINECOND_DRADCONDSUL[int(
                                    row_ug1[6][:-1])]) * 2)
                            if "A" in ph_w:
                                ...
                                if (DIAA > 0.0) and (DAE > 0.0):
                                    DAAP = 2.0 * DAE
                                    PAA = 11.176611 * math.log(
                                        DAAP / DIAA * 24.0)
                                    if "B" in ph_w:
                                        DABP = pow((pow(XB - XA, 2) +
                                                    pow(-YB - YA, 2)), 0.5)
                                        if DAB != 0:
                                            PAB = 11.176611 * math.log(
                                                DABP / DAB)
                                        else:
                                            PAB = 0.0
                                    else:
                                        PAB = 0.0
                                    if "C" in ph_w:
                                        DACP = pow((pow(XC - XA, 2) +
                                                    pow(-YC - YA, 2)), 0.5)
                                        if DAC != 0:
                                            PAC = 11.176611 * math.log(
                                                DACP / DAC)
                                        else:
                                            PAC = 0.0
                                    else:
                                        PAC = 0.0
                                    if int(row_ug1[6][:-1]) != -1:
                                        DANP = pow((pow(XN - XA, 2) +
                                                    pow(-YN - YA, 2)), 0.5)
                                        if DAN != 0:
                                            PAN = 11.176611 * math.log(
                                                DANP / DAN)
                                        else:
                                            PAN = 0.0
                                    else:
                            ...
                            if "B" in ph_w:
                                ...
                                if (DIAB > 0.0) and (DBE > 0.0):
                                    DBBP = 2.0 * DBE
                                    PBB = 11.176611 * math.log(
                                        DBBP / DIAB * 24.0)
                                    if "C" in ph_w:
                                        DBCP = pow((pow(XC - XB, 2) +
                                                    pow(-YC - YB, 2)), 0.5)
                                        if DBC != 0:
                                            PBC = 11.176611 * math.log(
                                                DBCP / DBC)
                                        else:
                                            PBC = 0.0
                                    else:
                                        PBC = 0.0
                                    if int(row_ug1[6][:-1]) != -1:
                                        DBNP = pow((pow(XN - XB, 2) +
                                                    pow(-YN - YB, 2)), 0.5)
                                        if DBN != 0:
                                            PBN = 11.176611 * math.log(
                                                DBNP / DBN)
                                        else:
                                            PBN = 0.0
                                    else:
                            ...
                            if "C" in ph_w:
                                ...
                                if (DIAC > 0.0) and (DCE > 0.0):
                                    DCCP = 2.0 * DCE
                                    PCC = 11.176611 * math.log(
                                        DCCP / DIAC * 24.0)
                                    if int(row_ug1[6][:-1]) != -1:
                                        DCNP = pow((pow(XN - XC, 2) +
                                                    pow(-YN - YC, 2)), 0.5)
                                        if DCN != 0:
                                            PCN = 11.176611 * math.log(
                                                DCNP / DCN)
                                        else:
                                            PCN = 0.0
                                    else:
                                ...
                                ZCN = 0.0
                            ZNN_INV = complex(0, 0)
                            if (int(row_ug1[6][:-1]) != -1 and GMRN_OH > 0.0 and
                                    RESN_OH > 0.0):
                                ZNN = complex(
                            ...
                            if "A" in ph_w and "B" not in ph_w and "C" not in ph_w:
                                ...
                                Yabc[0][0] = ((Pabc[1][1] * Pabc[2][2] -
                                               Pabc[1][2] * Pabc[2][1]) / DV *
                                              Cap_Freq)
                                Yabc[0][1] = ((Pabc[0][2] * Pabc[2][1] -
                                               Pabc[0][1] * Pabc[2][2]) / DV *
                                              Cap_Freq)
                                Yabc[0][2] = ((Pabc[0][1] * Pabc[1][2] -
                                               Pabc[0][2] * Pabc[1][1]) / DV *
                                              Cap_Freq)
                                Yabc[1][0] = ((Pabc[2][0] * Pabc[1][2] -
                                               Pabc[1][0] * Pabc[2][2]) / DV *
                                              Cap_Freq)
                                Yabc[1][1] = ((Pabc[0][0] * Pabc[2][2] -
                                               Pabc[0][2] * Pabc[2][0]) / DV *
                                              Cap_Freq)
                                Yabc[1][2] = ((Pabc[1][0] * Pabc[0][2] -
                                               Pabc[0][0] * Pabc[1][2]) / DV *
                                              Cap_Freq)
                                Yabc[2][0] = ((Pabc[1][0] * Pabc[2][1] -
                                               Pabc[1][1] * Pabc[2][0]) / DV *
                                              Cap_Freq)
                                Yabc[2][1] = ((Pabc[0][1] * Pabc[2][0] -
                                               Pabc[0][0] * Pabc[2][1]) / DV *
                                              Cap_Freq)
                                Yabc[2][2] = ((Pabc[0][0] * Pabc[1][1] -
                                               Pabc[0][1] * Pabc[1][0]) / DV *
                                              Cap_Freq)
                ...
                Yabc_red = (Yabc_red * 1000 / (2.6527 * Cap_Freq.imag)
                           )  # multiply 1000 to nF
                #                    logger.debug('--------------')
                #                    logger.debug(Yabc_red)
                if (np.mean(Zabc_red.real) == 0.0 and
                        np.mean(Zabc_red.imag) == 0.0 and
                        np.mean(Yabc_red) == 0.0):
            ...
            if entries[0] == "$CMP," and entries[5] == "115,":
                ...
                for ild, pld in enumerate(ph_ld):
                    ...
                    while True:
                        ...
                        if row_frm1_ld[0] == "$CMP," and row_frm1_ld[
                                1] == frm_ld:
                            ...
                            if row_frm1_ld[18] == "513,":
                                try:
                                    api_load.connecting_element = row_frm3_ld[
                                        1][1:-2]
                        ...
                        if row_ld_n[:7] == "$CMPCHN":
                            ...
                            try:
                                if row_ld1_n[17][:-1] == "1.000000":
                                    ...
                                    api_load.nominal_voltage = node_volt_dict[
                                        load_node]
                                else:
                                    api_load.connection_type = "Y"
                                    api_load.nominal_voltage = (
                                        node_volt_dict[load_node]) / pow(
                                            3, 0.5)
