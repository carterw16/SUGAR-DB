...
from .base import (Any, Bool, DiTToHasTraits, Float, Instance, Int, List,
                   Unicode, observe)
...
class Load(DiTToHasTraits):
    ...
    nominal_voltage = Float(help="""This is the nominal voltage of the load.""",
                            default_value=None)
    connection_type = Unicode(
        help=
        """The connection type (D, Y, Z, A) for Delta, Wye, Zigzag or autotransformer.""",
        default_value=None,
    )
    vmin = Float(
        help=
        """The minimum per-unit voltage value. Going below this implies constant impedance.""",
        default_value=None,
    )
    vmax = Float(
        help=
        """The maximum per-unit voltage value. Going below this implies constant impedance.""",
        default_value=None,
    )
    phase_loads = List(
        Instance(PhaseLoad),
    ...
    timeseries = List(
        Instance(Timeseries),
        help=
        """A list of all the timeseries elements used to represent the loads""",
        default_value=None,
    )
    ...
    peak_p = Float(
        help=
        """This parameter is the annual peak p value of all combined phases of the load""",
        default_value=None,
    )
    peak_q = Float(
        help=
        """This parameter is the annual peak q value of all combined phases of the load""",
        default_value=None,
    )
    peak_coincident_p = Float(
        help=
        """This parameter is the annual coincident peak p value of all combined phases of the load""",
        default_value=None,
    )
    peak_coincident_q = Float(
        help=
        """This parameter is the annual coincident peak q value of all combined phases of the load""",
        default_value=None,
    )
    yearly_energy = Float(
        help=
        """This is the total energy used by the load across all phases over a typical year""",
        default_value=None,
    )
    num_levels = Float(
    ...
    num_users = Float(help="""The number of users at the loadpoint""",
                      default_value=None)
    ...
    upstream_transformer_name = Unicode(
        help=
        """The name of the distribution transformer which serves this load""",
        default_value=None,
    )
    ...
    is_substation = Bool(
        help=
        """Flag that indicates wheter the element is inside a substation or not.""",
        default_value=False,
    )
    ...
    is_center_tap = Bool(
        help=
        """Flag that indicates whether the element is a center tap load or not.""",
    )
    center_tap_perct_1_N = Float(
        help=
        """Percentage of the load between active 1 and neutral. Should be a float between 0 and 1.""",
        default_value=None,
    )
    center_tap_perct_N_2 = Float(
        help=
        """Percentage of the load between neutal and active 2. Should be a float between 0 and 1.""",
        default_value=None,
    )
    center_tap_perct_1_2 = Float(
        help=
        """Percentage of the load between active 1 and active 2. Should be a float between 0 and 1.""",
        default_value=None,
    )
