...
class Wire(DiTToHasTraits):
    phase = Unicode(help="""The phase (A, B, C, N, s1, s2) of the wire""",
                    default_value=None)
    nameclass = Unicode(help="""The nameclass (e.g. 1/0_ACSR) of the wire""",
                        default_value=None)
    X = Float(
        help=
    ...
    insulation_thickness = Float(
        help=
        """Thickness of the insulation around the secondary live conductors""",
        default=None,
    )
    is_fuse = Bool(
    ...
    is_open = Bool(
        help=
        """This flag indicates whether or not the line is open (if it is a switch/fuse/breaker/recloser/sectionalizer/network protector).""",
        default_value=None,
    )
    ...
    interrupting_rating = Float(
        help=
        """The maximum current that can pass through the wire before the equipment disconnects.""",
        default_value=None,
    )
    ...
    concentric_neutral_gmr = Float(
        help=
        """The geometric mean radius of the neutral strand for a concentric neutral cable.""",
        default_value=None,
    )
    concentric_neutral_resistance = Float(
        help=
        """The per-unit length resistance of the neutral strand for a concentric neutral cable.""",
        default_value=None,
    )
    concentric_neutral_diameter = Float(
        help=
        """The diameter of the neutral strand of the concentric neutral cable.""",
        default_value=None,
    )
    ...
    is_recloser = Bool(
        help=
        """This flag indicates whether or not this wire is also a recloser""",
        default_value=None,
    )
    ...
    is_network_protector = Bool(
        help=
        """This flag indicates whether or not this wire is also a network protector.""",
        default_value=None,
    )
    ...
    is_sectionalizer = Bool(
        help=
        """This flag indicates whether or not this wire is also a sectionalizer.""",
        default_value=None,
    )
