...
"""
    ...
    nominal_voltage = Float(help="""Nominal voltage at the feeder head.""",
                            default_value=None)
    headnode = Unicode(help="""Name of the headnode/FEEDERHEAD.""",
                       default_value=None)
    transformer = Unicode(
    ...
    substation = Unicode(
        help=
        """Name of the object representing the substation in the feeder files (often a bus downstream of the transformer).""",
        default_value=None,
    )
    operating_voltage = Float(help="""Operating voltage at the feeder head.""",
                              default_value=None)
