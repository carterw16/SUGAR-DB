...
class Reactor(DiTToHasTraits):
    ...
    from_element = Any(
        help=
        """Name of the node which connects to the 'from' end of the reactor""",
        default_value=None,
    )
    to_element = Any(
        help=
        """'Name of the node which connects to the 'to' end of the reactor. If set to None, shunt reactor is assumed.""",
        default_value=None,
    )
    positions = List(
        Instance(Position),
    ...
    phase_reactors = List(
        ...
        help=
        """This parameter is a list of all the phase reactors composing the reactor.""",
        default_value=None,
    )
