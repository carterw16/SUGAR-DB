...
class Line(DiTToHasTraits):
    ...
    line_type = Unicode(help="""Whether the line is overhead or underground""",
                        default_value=None)
    length = Float(help="""This parameter is the length of the Line.""",
                   default_value=0)
    from_element = Any(
    ...
    from_element_connection_index = Int(
        help=
        """Index of the position in the node that the 'from' end of the line connects to (e.g. for a long bus)""",
        default_value=None,
    )
    to_element_connection_index = Int(
        help=
        """Index of the position in the node that the 'to' end of the line connects to (e.g. for a long bus)""",
        default_value=None,
    )
    ...
    is_banked = Bool(
        help=
        """This flag indicates whether or not the switch is banked. If this is true, the switch objects are controlled together""",
        default_value=None,
    )
    faultrate = Float(help="""The number of faults that occur per year""",
                      default_value=None)
    wires = List(
        Instance(Wire),
        help=
        """This parameter is a list of all the wires included on the line. The wires are objects containing elements of phase, X and Y. """,
        default_value=None,
    )
    positions = List(
        Instance(Position),
    ...
    is_recloser = Bool(
        help=
        """This flag indicates whether or not the line is also a recloser""",
        default_value=None,
    )
    ...
    is_sectionalizer = Bool(
        help=
        """This flag indicates whether or not the line is also a sectionalizer""",
        default_value=None,
    )

    # Modification: Nicolas (March 2018)
    nameclass = Unicode(help="""Nameclass of the line object.""",
                        default_value=None)
    ...
    is_network_protector = Bool(
        help=
        """This flag indicates whether or not the line is also a network protector.""",
        default_value=None,
    )
